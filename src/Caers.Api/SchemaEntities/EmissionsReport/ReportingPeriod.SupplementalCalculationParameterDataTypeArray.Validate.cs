    ...
    public readonly partial struct SupplementalCalculationParameterDataTypeArray
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("D:/projects/caers-api/src/Caers.Api/SchemaEntities/caers-report-openapi.json#/components/schemas/ReportingPeriod/properties/supplementalCalculationParameter");
            }
