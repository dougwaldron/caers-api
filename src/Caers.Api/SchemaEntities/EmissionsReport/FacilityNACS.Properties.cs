...
public readonly partial struct FacilityNACS
{
    ...
    /// Gets Code.
    /// </summary>
    public Caers.Api.SchemaEntities.FacilityNACS.CodeEntity Code
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.SchemaEntities.FacilityNACS.CodeEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.SchemaEntities.FacilityNACS.CodeEntity>();
                }
            }
    ...
    /// Gets NaicsCodeType.
    /// </summary>
    public Caers.Api.SchemaEntities.FacilityNACS.NaicsCodeTypeEntity NaicsCodeType
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.SchemaEntities.FacilityNACS.NaicsCodeTypeEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.SchemaEntities.FacilityNACS.NaicsCodeTypeEntity>();
                }
            }
    ...
    /// </summary>
    public static FacilityNACS Create(Caers.Api.SchemaEntities.FacilityNACS.CodeEntity code, Caers.Api.SchemaEntities.FacilityNACS.NaicsCodeTypeEntity naicsCodeType)
    {
    ...
    public FacilityNACS WithCode(in Caers.Api.SchemaEntities.FacilityNACS.CodeEntity value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public FacilityNACS WithNaicsCodeType(in Caers.Api.SchemaEntities.FacilityNACS.NaicsCodeTypeEntity value)
    {
    ...
    {
        return property.ValueAs<Caers.Api.SchemaEntities.FacilityNACS.CodeEntity>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<Caers.Api.SchemaEntities.FacilityNACS.NaicsCodeTypeEntity>().Validate(validationContext, level);
    }
