...
public readonly partial struct OperatingDetails
{
    ...
    /// </summary>
    public readonly partial struct PercentFallActivityEntity : IJsonNumber<PercentFallActivityEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "PercentFallActivityEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public PercentFallActivityEntity(double value)
        {
        ...
        public static implicit operator JsonNumber(PercentFallActivityEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator PercentFallActivityEntity(JsonNumber value)
        {
        ...
        public static implicit operator PercentFallActivityEntity(double value)
        {
            return new(value);
        }
        ...
        public static implicit operator double (PercentFallActivityEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator PercentFallActivityEntity(float value)
        {
            return new(value);
        }
        ...
        public static implicit operator float (PercentFallActivityEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator PercentFallActivityEntity(int value)
        {
            return new(value);
        }
        ...
        public static implicit operator int (PercentFallActivityEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator PercentFallActivityEntity(long value)
        {
            return new(value);
        }
        ...
        public static implicit operator long (PercentFallActivityEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator PercentFallActivityEntity(uint value)
        {
            return new(value);
        }
        ...
        public static implicit operator uint (PercentFallActivityEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator PercentFallActivityEntity(ushort value)
        {
            return new(value);
        }
        ...
        public static implicit operator ushort (PercentFallActivityEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator PercentFallActivityEntity(ulong value)
        {
            return new(value);
        }
        ...
        public static implicit operator ulong (PercentFallActivityEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator PercentFallActivityEntity(byte value)
        {
            return new(value);
        }
        ...
        public static implicit operator byte (PercentFallActivityEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator PercentFallActivityEntity(sbyte value)
        {
            return new(value);
        }
        ...
        public static implicit operator sbyte (PercentFallActivityEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
