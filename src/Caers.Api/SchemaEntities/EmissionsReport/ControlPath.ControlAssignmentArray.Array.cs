...
public readonly partial struct ControlPath
{
    ...
    /// </summary>
    public readonly partial struct ControlAssignmentArray : IJsonArray<ControlAssignmentArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly ControlAssignmentArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "ControlAssignmentArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ControlAssignmentArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ControlAssignmentArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(ControlAssignmentArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ControlAssignmentArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(ControlAssignmentArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ControlAssignmentArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static ControlAssignmentArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A ControlAssignmentArray instantiated from the given items.</returns>
        public static ControlAssignmentArray FromItems(in Caers.Api.SchemaEntities.ControlAssignment value1)
        {
        ...
        /// <returns>A ControlAssignmentArray instantiated from the given items.</returns>
        public static ControlAssignmentArray FromItems(in Caers.Api.SchemaEntities.ControlAssignment value1, in Caers.Api.SchemaEntities.ControlAssignment value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ControlAssignmentArray instantiated from the given items.</returns>
        public static ControlAssignmentArray FromItems(in Caers.Api.SchemaEntities.ControlAssignment value1, in Caers.Api.SchemaEntities.ControlAssignment value2, in Caers.Api.SchemaEntities.ControlAssignment value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ControlAssignmentArray FromItems(params Caers.Api.SchemaEntities.ControlAssignment[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.ControlAssignment item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ControlAssignmentArray FromRange(IEnumerable<Caers.Api.SchemaEntities.ControlAssignment> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.ControlAssignment item in value)
            {
        ...
        /// </remarks>
        public static ControlAssignmentArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new ControlAssignmentArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ControlAssignmentArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ControlAssignmentArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.ControlAssignment> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.ControlAssignment>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.ControlAssignment>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<ControlAssignmentArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<ControlAssignmentArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
