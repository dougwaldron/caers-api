...
public readonly partial struct ReleasePointAppt
{
    ...
    /// </summary>
    public readonly partial struct PathIdentificationIdentificationArray : IJsonArray<PathIdentificationIdentificationArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly PathIdentificationIdentificationArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "PathIdentificationIdentificationArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public PathIdentificationIdentificationArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public PathIdentificationIdentificationArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(PathIdentificationIdentificationArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator PathIdentificationIdentificationArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(PathIdentificationIdentificationArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator PathIdentificationIdentificationArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static PathIdentificationIdentificationArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A PathIdentificationIdentificationArray instantiated from the given items.</returns>
        public static PathIdentificationIdentificationArray FromItems(in Caers.Api.SchemaEntities.Identification value1)
        {
        ...
        /// <returns>A PathIdentificationIdentificationArray instantiated from the given items.</returns>
        public static PathIdentificationIdentificationArray FromItems(in Caers.Api.SchemaEntities.Identification value1, in Caers.Api.SchemaEntities.Identification value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A PathIdentificationIdentificationArray instantiated from the given items.</returns>
        public static PathIdentificationIdentificationArray FromItems(in Caers.Api.SchemaEntities.Identification value1, in Caers.Api.SchemaEntities.Identification value2, in Caers.Api.SchemaEntities.Identification value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static PathIdentificationIdentificationArray FromItems(params Caers.Api.SchemaEntities.Identification[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static PathIdentificationIdentificationArray FromRange(IEnumerable<Caers.Api.SchemaEntities.Identification> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.Identification item in value)
            {
        ...
        /// </remarks>
        public static PathIdentificationIdentificationArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new PathIdentificationIdentificationArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static PathIdentificationIdentificationArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static PathIdentificationIdentificationArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<PathIdentificationIdentificationArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<PathIdentificationIdentificationArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
