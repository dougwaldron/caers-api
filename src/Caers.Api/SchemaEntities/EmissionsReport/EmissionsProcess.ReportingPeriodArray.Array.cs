...
public readonly partial struct EmissionsProcess
{
    ...
    /// </summary>
    public readonly partial struct ReportingPeriodArray : IJsonArray<ReportingPeriodArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly ReportingPeriodArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "ReportingPeriodArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ReportingPeriodArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ReportingPeriodArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(ReportingPeriodArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ReportingPeriodArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(ReportingPeriodArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ReportingPeriodArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static ReportingPeriodArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A ReportingPeriodArray instantiated from the given items.</returns>
        public static ReportingPeriodArray FromItems(in Caers.Api.SchemaEntities.ReportingPeriod value1)
        {
        ...
        /// <returns>A ReportingPeriodArray instantiated from the given items.</returns>
        public static ReportingPeriodArray FromItems(in Caers.Api.SchemaEntities.ReportingPeriod value1, in Caers.Api.SchemaEntities.ReportingPeriod value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ReportingPeriodArray instantiated from the given items.</returns>
        public static ReportingPeriodArray FromItems(in Caers.Api.SchemaEntities.ReportingPeriod value1, in Caers.Api.SchemaEntities.ReportingPeriod value2, in Caers.Api.SchemaEntities.ReportingPeriod value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ReportingPeriodArray FromItems(params Caers.Api.SchemaEntities.ReportingPeriod[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.ReportingPeriod item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ReportingPeriodArray FromRange(IEnumerable<Caers.Api.SchemaEntities.ReportingPeriod> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.ReportingPeriod item in value)
            {
        ...
        /// </remarks>
        public static ReportingPeriodArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new ReportingPeriodArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ReportingPeriodArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ReportingPeriodArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.ReportingPeriod> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.ReportingPeriod>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.ReportingPeriod>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<ReportingPeriodArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<ReportingPeriodArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
