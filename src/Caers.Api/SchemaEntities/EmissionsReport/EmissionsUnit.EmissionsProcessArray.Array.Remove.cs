...
public readonly partial struct EmissionsUnit
{
    ...
    public readonly partial struct EmissionsProcessArray
    {
        ...
        public EmissionsProcessArray Remove(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public EmissionsProcessArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public EmissionsProcessArray RemoveRange(int index, int count)
        {
