...
public readonly partial struct EmissionsProcess
{
    ...
    /// </summary>
    public readonly partial struct ReleasePointApptArray : IJsonArray<ReleasePointApptArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly ReleasePointApptArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "ReleasePointApptArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ReleasePointApptArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ReleasePointApptArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(ReleasePointApptArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ReleasePointApptArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(ReleasePointApptArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ReleasePointApptArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static ReleasePointApptArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A ReleasePointApptArray instantiated from the given items.</returns>
        public static ReleasePointApptArray FromItems(in Caers.Api.SchemaEntities.ReleasePointAppt value1)
        {
        ...
        /// <returns>A ReleasePointApptArray instantiated from the given items.</returns>
        public static ReleasePointApptArray FromItems(in Caers.Api.SchemaEntities.ReleasePointAppt value1, in Caers.Api.SchemaEntities.ReleasePointAppt value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ReleasePointApptArray instantiated from the given items.</returns>
        public static ReleasePointApptArray FromItems(in Caers.Api.SchemaEntities.ReleasePointAppt value1, in Caers.Api.SchemaEntities.ReleasePointAppt value2, in Caers.Api.SchemaEntities.ReleasePointAppt value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ReleasePointApptArray FromItems(params Caers.Api.SchemaEntities.ReleasePointAppt[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.ReleasePointAppt item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ReleasePointApptArray FromRange(IEnumerable<Caers.Api.SchemaEntities.ReleasePointAppt> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.ReleasePointAppt item in value)
            {
        ...
        /// </remarks>
        public static ReleasePointApptArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new ReleasePointApptArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ReleasePointApptArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ReleasePointApptArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.ReleasePointAppt> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.ReleasePointAppt>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.ReleasePointAppt>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<ReleasePointApptArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<ReleasePointApptArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
