...
public readonly partial struct ReleasePoint
{
    ...
    /// </summary>
    public readonly partial struct IdentificationIdentificationArray : IJsonArray<IdentificationIdentificationArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly IdentificationIdentificationArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "IdentificationIdentificationArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public IdentificationIdentificationArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public IdentificationIdentificationArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(IdentificationIdentificationArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator IdentificationIdentificationArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(IdentificationIdentificationArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator IdentificationIdentificationArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static IdentificationIdentificationArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A IdentificationIdentificationArray instantiated from the given items.</returns>
        public static IdentificationIdentificationArray FromItems(in Caers.Api.SchemaEntities.Identification value1)
        {
        ...
        /// <returns>A IdentificationIdentificationArray instantiated from the given items.</returns>
        public static IdentificationIdentificationArray FromItems(in Caers.Api.SchemaEntities.Identification value1, in Caers.Api.SchemaEntities.Identification value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A IdentificationIdentificationArray instantiated from the given items.</returns>
        public static IdentificationIdentificationArray FromItems(in Caers.Api.SchemaEntities.Identification value1, in Caers.Api.SchemaEntities.Identification value2, in Caers.Api.SchemaEntities.Identification value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static IdentificationIdentificationArray FromItems(params Caers.Api.SchemaEntities.Identification[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static IdentificationIdentificationArray FromRange(IEnumerable<Caers.Api.SchemaEntities.Identification> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.Identification item in value)
            {
        ...
        /// </remarks>
        public static IdentificationIdentificationArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new IdentificationIdentificationArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static IdentificationIdentificationArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static IdentificationIdentificationArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<IdentificationIdentificationArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<IdentificationIdentificationArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
