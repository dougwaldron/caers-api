...
public readonly partial struct EmissionsProcess
{
    ...
    /// </summary>
    public readonly partial struct DeleteReportingPeriodDataTypeArray : IJsonArray<DeleteReportingPeriodDataTypeArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly DeleteReportingPeriodDataTypeArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "DeleteReportingPeriodDataTypeArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public DeleteReportingPeriodDataTypeArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public DeleteReportingPeriodDataTypeArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(DeleteReportingPeriodDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator DeleteReportingPeriodDataTypeArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(DeleteReportingPeriodDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator DeleteReportingPeriodDataTypeArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static DeleteReportingPeriodDataTypeArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A DeleteReportingPeriodDataTypeArray instantiated from the given items.</returns>
        public static DeleteReportingPeriodDataTypeArray FromItems(in Caers.Api.SchemaEntities.DeleteReportingPeriodDataType value1)
        {
        ...
        /// <returns>A DeleteReportingPeriodDataTypeArray instantiated from the given items.</returns>
        public static DeleteReportingPeriodDataTypeArray FromItems(in Caers.Api.SchemaEntities.DeleteReportingPeriodDataType value1, in Caers.Api.SchemaEntities.DeleteReportingPeriodDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A DeleteReportingPeriodDataTypeArray instantiated from the given items.</returns>
        public static DeleteReportingPeriodDataTypeArray FromItems(in Caers.Api.SchemaEntities.DeleteReportingPeriodDataType value1, in Caers.Api.SchemaEntities.DeleteReportingPeriodDataType value2, in Caers.Api.SchemaEntities.DeleteReportingPeriodDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static DeleteReportingPeriodDataTypeArray FromItems(params Caers.Api.SchemaEntities.DeleteReportingPeriodDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.DeleteReportingPeriodDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static DeleteReportingPeriodDataTypeArray FromRange(IEnumerable<Caers.Api.SchemaEntities.DeleteReportingPeriodDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.DeleteReportingPeriodDataType item in value)
            {
        ...
        /// </remarks>
        public static DeleteReportingPeriodDataTypeArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new DeleteReportingPeriodDataTypeArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static DeleteReportingPeriodDataTypeArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static DeleteReportingPeriodDataTypeArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.DeleteReportingPeriodDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.DeleteReportingPeriodDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.DeleteReportingPeriodDataType>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<DeleteReportingPeriodDataTypeArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<DeleteReportingPeriodDataTypeArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
