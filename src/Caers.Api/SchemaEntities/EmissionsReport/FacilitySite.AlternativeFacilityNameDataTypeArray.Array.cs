...
public readonly partial struct FacilitySite
{
    ...
    /// </summary>
    public readonly partial struct AlternativeFacilityNameDataTypeArray : IJsonArray<AlternativeFacilityNameDataTypeArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly AlternativeFacilityNameDataTypeArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "AlternativeFacilityNameDataTypeArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public AlternativeFacilityNameDataTypeArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public AlternativeFacilityNameDataTypeArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(AlternativeFacilityNameDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator AlternativeFacilityNameDataTypeArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(AlternativeFacilityNameDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator AlternativeFacilityNameDataTypeArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static AlternativeFacilityNameDataTypeArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A AlternativeFacilityNameDataTypeArray instantiated from the given items.</returns>
        public static AlternativeFacilityNameDataTypeArray FromItems(in Caers.Api.SchemaEntities.AlternativeFacilityNameDataType value1)
        {
        ...
        /// <returns>A AlternativeFacilityNameDataTypeArray instantiated from the given items.</returns>
        public static AlternativeFacilityNameDataTypeArray FromItems(in Caers.Api.SchemaEntities.AlternativeFacilityNameDataType value1, in Caers.Api.SchemaEntities.AlternativeFacilityNameDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A AlternativeFacilityNameDataTypeArray instantiated from the given items.</returns>
        public static AlternativeFacilityNameDataTypeArray FromItems(in Caers.Api.SchemaEntities.AlternativeFacilityNameDataType value1, in Caers.Api.SchemaEntities.AlternativeFacilityNameDataType value2, in Caers.Api.SchemaEntities.AlternativeFacilityNameDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static AlternativeFacilityNameDataTypeArray FromItems(params Caers.Api.SchemaEntities.AlternativeFacilityNameDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.AlternativeFacilityNameDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static AlternativeFacilityNameDataTypeArray FromRange(IEnumerable<Caers.Api.SchemaEntities.AlternativeFacilityNameDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.AlternativeFacilityNameDataType item in value)
            {
        ...
        /// </remarks>
        public static AlternativeFacilityNameDataTypeArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new AlternativeFacilityNameDataTypeArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static AlternativeFacilityNameDataTypeArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static AlternativeFacilityNameDataTypeArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.AlternativeFacilityNameDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.AlternativeFacilityNameDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.AlternativeFacilityNameDataType>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<AlternativeFacilityNameDataTypeArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<AlternativeFacilityNameDataTypeArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
