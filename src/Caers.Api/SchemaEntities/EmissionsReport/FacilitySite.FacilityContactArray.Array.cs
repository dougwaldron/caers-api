...
public readonly partial struct FacilitySite
{
    ...
    /// </summary>
    public readonly partial struct FacilityContactArray : IJsonArray<FacilityContactArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly FacilityContactArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "FacilityContactArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public FacilityContactArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public FacilityContactArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(FacilityContactArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator FacilityContactArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(FacilityContactArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator FacilityContactArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static FacilityContactArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A FacilityContactArray instantiated from the given items.</returns>
        public static FacilityContactArray FromItems(in Caers.Api.SchemaEntities.FacilityContact value1)
        {
        ...
        /// <returns>A FacilityContactArray instantiated from the given items.</returns>
        public static FacilityContactArray FromItems(in Caers.Api.SchemaEntities.FacilityContact value1, in Caers.Api.SchemaEntities.FacilityContact value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A FacilityContactArray instantiated from the given items.</returns>
        public static FacilityContactArray FromItems(in Caers.Api.SchemaEntities.FacilityContact value1, in Caers.Api.SchemaEntities.FacilityContact value2, in Caers.Api.SchemaEntities.FacilityContact value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static FacilityContactArray FromItems(params Caers.Api.SchemaEntities.FacilityContact[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.FacilityContact item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static FacilityContactArray FromRange(IEnumerable<Caers.Api.SchemaEntities.FacilityContact> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.FacilityContact item in value)
            {
        ...
        /// </remarks>
        public static FacilityContactArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new FacilityContactArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static FacilityContactArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static FacilityContactArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.FacilityContact> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.FacilityContact>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.FacilityContact>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<FacilityContactArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<FacilityContactArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
