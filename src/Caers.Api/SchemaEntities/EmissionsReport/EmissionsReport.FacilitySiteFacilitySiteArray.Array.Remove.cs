...
public readonly partial struct EmissionsReport
{
    ...
    public readonly partial struct FacilitySiteFacilitySiteArray
    {
        ...
        public FacilitySiteFacilitySiteArray Remove(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public FacilitySiteFacilitySiteArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public FacilitySiteFacilitySiteArray RemoveRange(int index, int count)
        {
