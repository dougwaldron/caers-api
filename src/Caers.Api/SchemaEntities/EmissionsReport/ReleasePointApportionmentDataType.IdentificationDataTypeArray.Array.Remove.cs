...
public readonly partial struct ReleasePointApportionmentDataType
{
    ...
    public readonly partial struct IdentificationDataTypeArray
    {
        ...
        public IdentificationDataTypeArray Remove(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IdentificationDataTypeArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public IdentificationDataTypeArray RemoveRange(int index, int count)
        {
