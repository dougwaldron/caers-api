...
public readonly partial struct Identification
{
    ...
    /// Gets Identifier.
    /// </summary>
    public Caers.Api.SchemaEntities.Identification.IdentifierEntity Identifier
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.SchemaEntities.Identification.IdentifierEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.SchemaEntities.Identification.IdentifierEntity>();
                }
            }
    ...
    /// </summary>
    public Caers.Api.SchemaEntities.Identification.ProgramSystemCodeEntity ProgramSystemCode
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.SchemaEntities.Identification.ProgramSystemCodeEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.SchemaEntities.Identification.ProgramSystemCodeEntity>();
                }
            }
    ...
    /// <summary>
    /// Creates an instance of a <see cref = "Identification"/>.
    /// </summary>
    public static Identification Create(Caers.Api.SchemaEntities.Identification.IdentifierEntity identifier, Corvus.Json.JsonDate? effectiveDate = null, Corvus.Json.JsonDate? endDate = null, Corvus.Json.JsonString? identifierIsReadOnly = null, Caers.Api.SchemaEntities.Identification.ProgramSystemCodeEntity? programSystemCode = null)
    {
        ...
        if (programSystemCode is Caers.Api.SchemaEntities.Identification.ProgramSystemCodeEntity programSystemCode__)
        {
    ...
    public Identification WithEffectiveDate(in Corvus.Json.JsonDate value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public Identification WithEndDate(in Corvus.Json.JsonDate value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public Identification WithIdentifier(in Caers.Api.SchemaEntities.Identification.IdentifierEntity value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public Identification WithIdentifierIsReadOnly(in Corvus.Json.JsonString value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public Identification WithProgramSystemCode(in Caers.Api.SchemaEntities.Identification.ProgramSystemCodeEntity value)
    {
    ...
    {
        return property.ValueAs<Caers.Api.SchemaEntities.Identification.IdentifierEntity>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<Caers.Api.SchemaEntities.Identification.ProgramSystemCodeEntity>().Validate(validationContext, level);
    }
