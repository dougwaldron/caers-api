...
public readonly partial struct EventLocationDataType
{
    ...
    /// </summary>
    public readonly partial struct EventEmissionsProcessDataTypeArray : IJsonArray<EventEmissionsProcessDataTypeArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly EventEmissionsProcessDataTypeArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "EventEmissionsProcessDataTypeArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public EventEmissionsProcessDataTypeArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public EventEmissionsProcessDataTypeArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(EventEmissionsProcessDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator EventEmissionsProcessDataTypeArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(EventEmissionsProcessDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator EventEmissionsProcessDataTypeArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static EventEmissionsProcessDataTypeArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A EventEmissionsProcessDataTypeArray instantiated from the given items.</returns>
        public static EventEmissionsProcessDataTypeArray FromItems(in Caers.Api.SchemaEntities.EventEmissionsProcessDataType value1)
        {
        ...
        /// <returns>A EventEmissionsProcessDataTypeArray instantiated from the given items.</returns>
        public static EventEmissionsProcessDataTypeArray FromItems(in Caers.Api.SchemaEntities.EventEmissionsProcessDataType value1, in Caers.Api.SchemaEntities.EventEmissionsProcessDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A EventEmissionsProcessDataTypeArray instantiated from the given items.</returns>
        public static EventEmissionsProcessDataTypeArray FromItems(in Caers.Api.SchemaEntities.EventEmissionsProcessDataType value1, in Caers.Api.SchemaEntities.EventEmissionsProcessDataType value2, in Caers.Api.SchemaEntities.EventEmissionsProcessDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static EventEmissionsProcessDataTypeArray FromItems(params Caers.Api.SchemaEntities.EventEmissionsProcessDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.EventEmissionsProcessDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static EventEmissionsProcessDataTypeArray FromRange(IEnumerable<Caers.Api.SchemaEntities.EventEmissionsProcessDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.EventEmissionsProcessDataType item in value)
            {
        ...
        /// </remarks>
        public static EventEmissionsProcessDataTypeArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new EventEmissionsProcessDataTypeArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static EventEmissionsProcessDataTypeArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static EventEmissionsProcessDataTypeArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.EventEmissionsProcessDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.EventEmissionsProcessDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.EventEmissionsProcessDataType>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<EventEmissionsProcessDataTypeArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<EventEmissionsProcessDataTypeArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
