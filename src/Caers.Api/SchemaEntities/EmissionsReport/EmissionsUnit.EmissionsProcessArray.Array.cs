...
public readonly partial struct EmissionsUnit
{
    ...
    /// </summary>
    public readonly partial struct EmissionsProcessArray : IJsonArray<EmissionsProcessArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly EmissionsProcessArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "EmissionsProcessArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public EmissionsProcessArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public EmissionsProcessArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(EmissionsProcessArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator EmissionsProcessArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(EmissionsProcessArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator EmissionsProcessArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static EmissionsProcessArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A EmissionsProcessArray instantiated from the given items.</returns>
        public static EmissionsProcessArray FromItems(in Caers.Api.SchemaEntities.EmissionsProcess value1)
        {
        ...
        /// <returns>A EmissionsProcessArray instantiated from the given items.</returns>
        public static EmissionsProcessArray FromItems(in Caers.Api.SchemaEntities.EmissionsProcess value1, in Caers.Api.SchemaEntities.EmissionsProcess value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A EmissionsProcessArray instantiated from the given items.</returns>
        public static EmissionsProcessArray FromItems(in Caers.Api.SchemaEntities.EmissionsProcess value1, in Caers.Api.SchemaEntities.EmissionsProcess value2, in Caers.Api.SchemaEntities.EmissionsProcess value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static EmissionsProcessArray FromItems(params Caers.Api.SchemaEntities.EmissionsProcess[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.EmissionsProcess item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static EmissionsProcessArray FromRange(IEnumerable<Caers.Api.SchemaEntities.EmissionsProcess> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.EmissionsProcess item in value)
            {
        ...
        /// </remarks>
        public static EmissionsProcessArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new EmissionsProcessArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static EmissionsProcessArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static EmissionsProcessArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.EmissionsProcess> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.EmissionsProcess>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.EmissionsProcess>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<EmissionsProcessArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<EmissionsProcessArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
