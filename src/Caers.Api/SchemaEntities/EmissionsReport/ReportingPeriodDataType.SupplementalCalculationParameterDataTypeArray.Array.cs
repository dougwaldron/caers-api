...
public readonly partial struct ReportingPeriodDataType
{
    ...
    /// </summary>
    public readonly partial struct SupplementalCalculationParameterDataTypeArray : IJsonArray<SupplementalCalculationParameterDataTypeArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly SupplementalCalculationParameterDataTypeArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "SupplementalCalculationParameterDataTypeArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public SupplementalCalculationParameterDataTypeArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public SupplementalCalculationParameterDataTypeArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(SupplementalCalculationParameterDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SupplementalCalculationParameterDataTypeArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(SupplementalCalculationParameterDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator SupplementalCalculationParameterDataTypeArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static SupplementalCalculationParameterDataTypeArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A SupplementalCalculationParameterDataTypeArray instantiated from the given items.</returns>
        public static SupplementalCalculationParameterDataTypeArray FromItems(in Caers.Api.SchemaEntities.SupplementalCalculationParameterDataType value1)
        {
        ...
        /// <returns>A SupplementalCalculationParameterDataTypeArray instantiated from the given items.</returns>
        public static SupplementalCalculationParameterDataTypeArray FromItems(in Caers.Api.SchemaEntities.SupplementalCalculationParameterDataType value1, in Caers.Api.SchemaEntities.SupplementalCalculationParameterDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A SupplementalCalculationParameterDataTypeArray instantiated from the given items.</returns>
        public static SupplementalCalculationParameterDataTypeArray FromItems(in Caers.Api.SchemaEntities.SupplementalCalculationParameterDataType value1, in Caers.Api.SchemaEntities.SupplementalCalculationParameterDataType value2, in Caers.Api.SchemaEntities.SupplementalCalculationParameterDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static SupplementalCalculationParameterDataTypeArray FromItems(params Caers.Api.SchemaEntities.SupplementalCalculationParameterDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.SupplementalCalculationParameterDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static SupplementalCalculationParameterDataTypeArray FromRange(IEnumerable<Caers.Api.SchemaEntities.SupplementalCalculationParameterDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.SupplementalCalculationParameterDataType item in value)
            {
        ...
        /// </remarks>
        public static SupplementalCalculationParameterDataTypeArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new SupplementalCalculationParameterDataTypeArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static SupplementalCalculationParameterDataTypeArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static SupplementalCalculationParameterDataTypeArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.SupplementalCalculationParameterDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.SupplementalCalculationParameterDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.SupplementalCalculationParameterDataType>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<SupplementalCalculationParameterDataTypeArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<SupplementalCalculationParameterDataTypeArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
