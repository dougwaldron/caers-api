...
public readonly partial struct ProcessDataType
{
    ...
    /// </summary>
    public readonly partial struct RegulationDataTypeArray : IJsonArray<RegulationDataTypeArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly RegulationDataTypeArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "RegulationDataTypeArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public RegulationDataTypeArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public RegulationDataTypeArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(RegulationDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator RegulationDataTypeArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(RegulationDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator RegulationDataTypeArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static RegulationDataTypeArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A RegulationDataTypeArray instantiated from the given items.</returns>
        public static RegulationDataTypeArray FromItems(in Caers.Api.SchemaEntities.RegulationDataType value1)
        {
        ...
        /// <returns>A RegulationDataTypeArray instantiated from the given items.</returns>
        public static RegulationDataTypeArray FromItems(in Caers.Api.SchemaEntities.RegulationDataType value1, in Caers.Api.SchemaEntities.RegulationDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A RegulationDataTypeArray instantiated from the given items.</returns>
        public static RegulationDataTypeArray FromItems(in Caers.Api.SchemaEntities.RegulationDataType value1, in Caers.Api.SchemaEntities.RegulationDataType value2, in Caers.Api.SchemaEntities.RegulationDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static RegulationDataTypeArray FromItems(params Caers.Api.SchemaEntities.RegulationDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.RegulationDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static RegulationDataTypeArray FromRange(IEnumerable<Caers.Api.SchemaEntities.RegulationDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.RegulationDataType item in value)
            {
        ...
        /// </remarks>
        public static RegulationDataTypeArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new RegulationDataTypeArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static RegulationDataTypeArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static RegulationDataTypeArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.RegulationDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.RegulationDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.RegulationDataType>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<RegulationDataTypeArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<RegulationDataTypeArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
