...
public readonly partial struct FacilitySite
{
    ...
    /// </summary>
    public readonly partial struct AddressArray : IJsonArray<AddressArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly AddressArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "AddressArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public AddressArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public AddressArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        /// <returns>A AddressArray instantiated from the given items.</returns>
        public static AddressArray FromItems(in Caers.Api.SchemaEntities.Address value1)
        {
        ...
        /// <returns>A AddressArray instantiated from the given items.</returns>
        public static AddressArray FromItems(in Caers.Api.SchemaEntities.Address value1, in Caers.Api.SchemaEntities.Address value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A AddressArray instantiated from the given items.</returns>
        public static AddressArray FromItems(in Caers.Api.SchemaEntities.Address value1, in Caers.Api.SchemaEntities.Address value2, in Caers.Api.SchemaEntities.Address value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static AddressArray FromItems(params Caers.Api.SchemaEntities.Address[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.Address item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static AddressArray FromRange(IEnumerable<Caers.Api.SchemaEntities.Address> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.Address item in value)
            {
        ...
        /// </remarks>
        public static AddressArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new AddressArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static AddressArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static AddressArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.Address> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.Address>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.Address>(this.arrayBacking);
            }
