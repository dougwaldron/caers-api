...
public readonly partial struct ProcessDataType
{
    ...
    public readonly partial struct ReleasePointApportionmentDataTypeArray : IJsonArray<ReleasePointApportionmentDataTypeArray>
    {
        ...
        public static ReleasePointApportionmentDataTypeArray FromItems(in Caers.Api.SchemaEntities.ReleasePointApportionmentDataType value1)
        {
        ...
        /// <returns>A ReleasePointApportionmentDataTypeArray instantiated from the given items.</returns>
        public static ReleasePointApportionmentDataTypeArray FromItems(in Caers.Api.SchemaEntities.ReleasePointApportionmentDataType value1, in Caers.Api.SchemaEntities.ReleasePointApportionmentDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ReleasePointApportionmentDataTypeArray instantiated from the given items.</returns>
        public static ReleasePointApportionmentDataTypeArray FromItems(in Caers.Api.SchemaEntities.ReleasePointApportionmentDataType value1, in Caers.Api.SchemaEntities.ReleasePointApportionmentDataType value2, in Caers.Api.SchemaEntities.ReleasePointApportionmentDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ReleasePointApportionmentDataTypeArray FromItems(params Caers.Api.SchemaEntities.ReleasePointApportionmentDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.ReleasePointApportionmentDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ReleasePointApportionmentDataTypeArray FromRange(IEnumerable<Caers.Api.SchemaEntities.ReleasePointApportionmentDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.ReleasePointApportionmentDataType item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.ReleasePointApportionmentDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.ReleasePointApportionmentDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.ReleasePointApportionmentDataType>(this.arrayBacking);
            }
