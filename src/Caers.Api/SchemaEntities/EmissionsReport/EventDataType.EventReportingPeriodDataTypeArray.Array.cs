...
public readonly partial struct EventDataType
{
    ...
    /// </summary>
    public readonly partial struct EventReportingPeriodDataTypeArray : IJsonArray<EventReportingPeriodDataTypeArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly EventReportingPeriodDataTypeArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "EventReportingPeriodDataTypeArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public EventReportingPeriodDataTypeArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public EventReportingPeriodDataTypeArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(EventReportingPeriodDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator EventReportingPeriodDataTypeArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(EventReportingPeriodDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator EventReportingPeriodDataTypeArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static EventReportingPeriodDataTypeArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A EventReportingPeriodDataTypeArray instantiated from the given items.</returns>
        public static EventReportingPeriodDataTypeArray FromItems(in Caers.Api.SchemaEntities.EventReportingPeriodDataType value1)
        {
        ...
        /// <returns>A EventReportingPeriodDataTypeArray instantiated from the given items.</returns>
        public static EventReportingPeriodDataTypeArray FromItems(in Caers.Api.SchemaEntities.EventReportingPeriodDataType value1, in Caers.Api.SchemaEntities.EventReportingPeriodDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A EventReportingPeriodDataTypeArray instantiated from the given items.</returns>
        public static EventReportingPeriodDataTypeArray FromItems(in Caers.Api.SchemaEntities.EventReportingPeriodDataType value1, in Caers.Api.SchemaEntities.EventReportingPeriodDataType value2, in Caers.Api.SchemaEntities.EventReportingPeriodDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static EventReportingPeriodDataTypeArray FromItems(params Caers.Api.SchemaEntities.EventReportingPeriodDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.EventReportingPeriodDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static EventReportingPeriodDataTypeArray FromRange(IEnumerable<Caers.Api.SchemaEntities.EventReportingPeriodDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.EventReportingPeriodDataType item in value)
            {
        ...
        /// </remarks>
        public static EventReportingPeriodDataTypeArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new EventReportingPeriodDataTypeArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static EventReportingPeriodDataTypeArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static EventReportingPeriodDataTypeArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.EventReportingPeriodDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.EventReportingPeriodDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.EventReportingPeriodDataType>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<EventReportingPeriodDataTypeArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<EventReportingPeriodDataTypeArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
