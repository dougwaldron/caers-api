...
public readonly partial struct EventReportingPeriodDataType
{
    ...
    /// Gets EventLocation.
    /// </summary>
    public Caers.Api.SchemaEntities.EventReportingPeriodDataType.EventLocationDataTypeArray EventLocation
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.SchemaEntities.EventReportingPeriodDataType.EventLocationDataTypeArray(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.SchemaEntities.EventReportingPeriodDataType.EventLocationDataTypeArray>();
                }
            }
    ...
    /// </summary>
    public static EventReportingPeriodDataType Create(Corvus.Json.JsonDateTime eventBeginDate, Corvus.Json.JsonDateTime eventEndDate, Caers.Api.SchemaEntities.EventReportingPeriodDataType.EventLocationDataTypeArray eventLocation, Corvus.Json.JsonString? beginHour = null, Corvus.Json.JsonString? endHour = null, Corvus.Json.JsonString? eventReportingPeriodComment = null, Corvus.Json.JsonString? eventStageCode = null)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public EventReportingPeriodDataType WithEventLocation(in Caers.Api.SchemaEntities.EventReportingPeriodDataType.EventLocationDataTypeArray value)
    {
    ...
    {
        return property.ValueAs<Caers.Api.SchemaEntities.EventReportingPeriodDataType.EventLocationDataTypeArray>().Validate(validationContext, level);
    }
