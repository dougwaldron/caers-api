...
public readonly partial struct ReleasePointApportionmentDataType
{
    ...
    /// </summary>
    public Caers.Api.SchemaEntities.ReleasePointApportionmentDataType.IdentificationDataTypeArray ReleasePointApportionmentIdentification
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.SchemaEntities.ReleasePointApportionmentDataType.IdentificationDataTypeArray(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.SchemaEntities.ReleasePointApportionmentDataType.IdentificationDataTypeArray>();
                }
            }
    ...
    /// </summary>
    public Caers.Api.SchemaEntities.ReleasePointApportionmentDataType.ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray ReleasePointApportionmentPathIdentification
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.SchemaEntities.ReleasePointApportionmentDataType.ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.SchemaEntities.ReleasePointApportionmentDataType.ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray>();
                }
            }
    ...
    /// </summary>
    public static ReleasePointApportionmentDataType Create(Corvus.Json.JsonString averagePercentEmissions, Caers.Api.SchemaEntities.ReleasePointApportionmentDataType.IdentificationDataTypeArray releasePointApportionmentIdentification, Corvus.Json.JsonString? releasePointApportionmentComment = null, Corvus.Json.JsonString? releasePointApportionmentIsUncontrolled = null, Caers.Api.SchemaEntities.ReleasePointApportionmentDataType.ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray? releasePointApportionmentPathIdentification = null)
    {
        ...
        if (releasePointApportionmentPathIdentification is Caers.Api.SchemaEntities.ReleasePointApportionmentDataType.ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray releasePointApportionmentPathIdentification__)
        {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public ReleasePointApportionmentDataType WithReleasePointApportionmentIdentification(in Caers.Api.SchemaEntities.ReleasePointApportionmentDataType.IdentificationDataTypeArray value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public ReleasePointApportionmentDataType WithReleasePointApportionmentPathIdentification(in Caers.Api.SchemaEntities.ReleasePointApportionmentDataType.ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray value)
    {
    ...
    {
        return property.ValueAs<Caers.Api.SchemaEntities.ReleasePointApportionmentDataType.IdentificationDataTypeArray>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<Caers.Api.SchemaEntities.ReleasePointApportionmentDataType.ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray>().Validate(validationContext, level);
    }
