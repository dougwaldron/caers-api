...
public readonly partial struct MeasureUnit
{
    ...
    /// Gets Code.
    /// </summary>
    public Caers.Api.SchemaEntities.MeasureUnit.CodeEntity Code
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.SchemaEntities.MeasureUnit.CodeEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.SchemaEntities.MeasureUnit.CodeEntity>();
                }
            }
    ...
    /// </summary>
    public static MeasureUnit Create(Caers.Api.SchemaEntities.MeasureUnit.CodeEntity code, Corvus.Json.JsonString? description = null)
    {
    ...
    public MeasureUnit WithCode(in Caers.Api.SchemaEntities.MeasureUnit.CodeEntity value)
    {
    ...
    {
        return property.ValueAs<Caers.Api.SchemaEntities.MeasureUnit.CodeEntity>().Validate(validationContext, level);
    }
