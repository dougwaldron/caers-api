...
/// </summary>
public readonly partial struct EventEmissionsProcessDataType : IJsonObject<EventEmissionsProcessDataType>
{
    /// <summary>
    /// Initializes a new instance of the <see cref = "EventEmissionsProcessDataType"/> struct.
    /// </summary>
    /// <param name = "value">The value from which to construct the instance.</param>
    public EventEmissionsProcessDataType(ImmutableDictionary<JsonPropertyName, JsonAny> value)
    {
    ...
    public static implicit operator JsonObject(EventEmissionsProcessDataType value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator EventEmissionsProcessDataType(JsonObject value)
    {
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator EventEmissionsProcessDataType(ImmutableDictionary<JsonPropertyName, JsonAny> value)
    {
        return new(value);
    }
    ...
    /// </summary>
    /// <param name = "value">The value from which to convert.</param>
    public static implicit operator ImmutableDictionary<JsonPropertyName, JsonAny>(EventEmissionsProcessDataType value)
    {
    ...
    public static EventEmissionsProcessDataType FromProperties(IDictionary<JsonPropertyName, JsonAny> source)
    {
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static EventEmissionsProcessDataType FromProperties(ImmutableDictionary<JsonPropertyName, JsonAny> source)
    {
        return new(source);
    }
    ...
    /// <param name = "source">The dictionary of properties.</param>
    /// <returns>An instance of the type initialized from the dictionary of properties.</returns>
    public static EventEmissionsProcessDataType FromProperties(params (JsonPropertyName Name, JsonAny Value)[] source)
    {
    ...
    /// <inheritdoc/>
    public EventEmissionsProcessDataType SetProperty<TValue>(in JsonPropertyName name, TValue value)
    ...
    /// <inheritdoc/>
    public EventEmissionsProcessDataType SetProperty<TValue>(string name, TValue value)
        where TValue : struct, IJsonValue
    {
        return new(this.GetImmutableDictionaryWith(name, value.AsAny));
    }
    ...
    /// <inheritdoc/>
    public EventEmissionsProcessDataType SetProperty<TValue>(ReadOnlySpan<char> name, TValue value)
        where TValue : struct, IJsonValue
    {
        return new(this.GetImmutableDictionaryWith(name, value.AsAny));
    }
    ...
    /// <inheritdoc/>
    public EventEmissionsProcessDataType SetProperty<TValue>(ReadOnlySpan<byte> utf8Name, TValue value)
        where TValue : struct, IJsonValue
    {
    ...
    /// <inheritdoc/>
    public EventEmissionsProcessDataType RemoveProperty(in JsonPropertyName name)
    {
        return new(this.GetImmutableDictionaryWithout(name));
    }

    /// <inheritdoc/>
    public EventEmissionsProcessDataType RemoveProperty(string name)
    {
        return new(this.GetImmutableDictionaryWithout(name));
    }

    /// <inheritdoc/>
    public EventEmissionsProcessDataType RemoveProperty(ReadOnlySpan<char> name)
    {
        return new(this.GetImmutableDictionaryWithout(name));
    }

    /// <inheritdoc/>
    public EventEmissionsProcessDataType RemoveProperty(ReadOnlySpan<byte> utf8Name)
    {
