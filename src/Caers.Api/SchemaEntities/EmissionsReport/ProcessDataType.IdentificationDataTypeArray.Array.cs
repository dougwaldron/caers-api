...
public readonly partial struct ProcessDataType
{
    ...
    /// </summary>
    public readonly partial struct IdentificationDataTypeArray : IJsonArray<IdentificationDataTypeArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly IdentificationDataTypeArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "IdentificationDataTypeArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public IdentificationDataTypeArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public IdentificationDataTypeArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(IdentificationDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator IdentificationDataTypeArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(IdentificationDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator IdentificationDataTypeArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static IdentificationDataTypeArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A IdentificationDataTypeArray instantiated from the given items.</returns>
        public static IdentificationDataTypeArray FromItems(in Caers.Api.SchemaEntities.IdentificationDataType value1)
        {
        ...
        /// <returns>A IdentificationDataTypeArray instantiated from the given items.</returns>
        public static IdentificationDataTypeArray FromItems(in Caers.Api.SchemaEntities.IdentificationDataType value1, in Caers.Api.SchemaEntities.IdentificationDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A IdentificationDataTypeArray instantiated from the given items.</returns>
        public static IdentificationDataTypeArray FromItems(in Caers.Api.SchemaEntities.IdentificationDataType value1, in Caers.Api.SchemaEntities.IdentificationDataType value2, in Caers.Api.SchemaEntities.IdentificationDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static IdentificationDataTypeArray FromItems(params Caers.Api.SchemaEntities.IdentificationDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static IdentificationDataTypeArray FromRange(IEnumerable<Caers.Api.SchemaEntities.IdentificationDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.IdentificationDataType item in value)
            {
        ...
        /// </remarks>
        public static IdentificationDataTypeArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new IdentificationDataTypeArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static IdentificationDataTypeArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static IdentificationDataTypeArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<IdentificationDataTypeArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<IdentificationDataTypeArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
