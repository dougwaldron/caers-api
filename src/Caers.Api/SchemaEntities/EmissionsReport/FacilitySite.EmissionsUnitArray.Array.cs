...
public readonly partial struct FacilitySite
{
    ...
    /// </summary>
    public readonly partial struct EmissionsUnitArray : IJsonArray<EmissionsUnitArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly EmissionsUnitArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "EmissionsUnitArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public EmissionsUnitArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public EmissionsUnitArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(EmissionsUnitArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator EmissionsUnitArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(EmissionsUnitArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator EmissionsUnitArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static EmissionsUnitArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A EmissionsUnitArray instantiated from the given items.</returns>
        public static EmissionsUnitArray FromItems(in Caers.Api.SchemaEntities.EmissionsUnit value1)
        {
        ...
        /// <returns>A EmissionsUnitArray instantiated from the given items.</returns>
        public static EmissionsUnitArray FromItems(in Caers.Api.SchemaEntities.EmissionsUnit value1, in Caers.Api.SchemaEntities.EmissionsUnit value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A EmissionsUnitArray instantiated from the given items.</returns>
        public static EmissionsUnitArray FromItems(in Caers.Api.SchemaEntities.EmissionsUnit value1, in Caers.Api.SchemaEntities.EmissionsUnit value2, in Caers.Api.SchemaEntities.EmissionsUnit value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static EmissionsUnitArray FromItems(params Caers.Api.SchemaEntities.EmissionsUnit[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.EmissionsUnit item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static EmissionsUnitArray FromRange(IEnumerable<Caers.Api.SchemaEntities.EmissionsUnit> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.EmissionsUnit item in value)
            {
        ...
        /// </remarks>
        public static EmissionsUnitArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new EmissionsUnitArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static EmissionsUnitArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static EmissionsUnitArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.EmissionsUnit> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.EmissionsUnit>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.EmissionsUnit>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<EmissionsUnitArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<EmissionsUnitArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
