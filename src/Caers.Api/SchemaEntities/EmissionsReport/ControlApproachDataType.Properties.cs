...
public readonly partial struct ControlApproachDataType
{
    ...
    /// Gets ControlMeasure.
    /// </summary>
    public Caers.Api.SchemaEntities.ControlApproachDataType.ControlMeasureDataTypeArray ControlMeasure
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.SchemaEntities.ControlApproachDataType.ControlMeasureDataTypeArray(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.SchemaEntities.ControlApproachDataType.ControlMeasureDataTypeArray>();
                }
            }
    ...
    /// </summary>
    public Caers.Api.SchemaEntities.ControlApproachDataType.ControlPollutantDataTypeArray ControlPollutant
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.SchemaEntities.ControlApproachDataType.ControlPollutantDataTypeArray(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.SchemaEntities.ControlApproachDataType.ControlPollutantDataTypeArray>();
                }
            }
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public ControlApproachDataType WithControlMeasure(in Caers.Api.SchemaEntities.ControlApproachDataType.ControlMeasureDataTypeArray value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public ControlApproachDataType WithControlPollutant(in Caers.Api.SchemaEntities.ControlApproachDataType.ControlPollutantDataTypeArray value)
    {
    ...
    {
        return property.ValueAs<Caers.Api.SchemaEntities.ControlApproachDataType.ControlMeasureDataTypeArray>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<Caers.Api.SchemaEntities.ControlApproachDataType.ControlPollutantDataTypeArray>().Validate(validationContext, level);
    }
