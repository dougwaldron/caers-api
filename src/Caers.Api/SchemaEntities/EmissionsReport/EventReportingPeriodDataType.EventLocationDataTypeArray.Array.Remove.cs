...
public readonly partial struct EventReportingPeriodDataType
{
    ...
    public readonly partial struct EventLocationDataTypeArray
    {
        ...
        public EventLocationDataTypeArray Remove(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public EventLocationDataTypeArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public EventLocationDataTypeArray RemoveRange(int index, int count)
        {
