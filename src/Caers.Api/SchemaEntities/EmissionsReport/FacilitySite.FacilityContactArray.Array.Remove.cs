...
public readonly partial struct FacilitySite
{
    ...
    public readonly partial struct FacilityContactArray
    {
        ...
        public FacilityContactArray Remove(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public FacilityContactArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public FacilityContactArray RemoveRange(int index, int count)
        {
