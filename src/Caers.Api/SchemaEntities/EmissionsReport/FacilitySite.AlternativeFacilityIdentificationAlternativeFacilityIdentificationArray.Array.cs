...
public readonly partial struct FacilitySite
{
    ...
    /// </summary>
    public readonly partial struct AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray : IJsonArray<AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        ...
        public AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray instantiated from the given items.</returns>
        public static AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray FromItems(in Caers.Api.SchemaEntities.AlternativeFacilityIdentification value1)
        {
        ...
        /// <returns>A AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray instantiated from the given items.</returns>
        public static AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray FromItems(in Caers.Api.SchemaEntities.AlternativeFacilityIdentification value1, in Caers.Api.SchemaEntities.AlternativeFacilityIdentification value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray instantiated from the given items.</returns>
        public static AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray FromItems(in Caers.Api.SchemaEntities.AlternativeFacilityIdentification value1, in Caers.Api.SchemaEntities.AlternativeFacilityIdentification value2, in Caers.Api.SchemaEntities.AlternativeFacilityIdentification value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray FromItems(params Caers.Api.SchemaEntities.AlternativeFacilityIdentification[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.AlternativeFacilityIdentification item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray FromRange(IEnumerable<Caers.Api.SchemaEntities.AlternativeFacilityIdentification> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.AlternativeFacilityIdentification item in value)
            {
        ...
        /// </remarks>
        public static AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.AlternativeFacilityIdentification> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.AlternativeFacilityIdentification>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.AlternativeFacilityIdentification>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
