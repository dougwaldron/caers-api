...
public readonly partial struct ControlApproachDataType
{
    ...
    /// </summary>
    public readonly partial struct ControlMeasureDataTypeArray : IJsonArray<ControlMeasureDataTypeArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly ControlMeasureDataTypeArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "ControlMeasureDataTypeArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ControlMeasureDataTypeArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ControlMeasureDataTypeArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(ControlMeasureDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ControlMeasureDataTypeArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(ControlMeasureDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ControlMeasureDataTypeArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static ControlMeasureDataTypeArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A ControlMeasureDataTypeArray instantiated from the given items.</returns>
        public static ControlMeasureDataTypeArray FromItems(in Caers.Api.SchemaEntities.ControlMeasureDataType value1)
        {
        ...
        /// <returns>A ControlMeasureDataTypeArray instantiated from the given items.</returns>
        public static ControlMeasureDataTypeArray FromItems(in Caers.Api.SchemaEntities.ControlMeasureDataType value1, in Caers.Api.SchemaEntities.ControlMeasureDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ControlMeasureDataTypeArray instantiated from the given items.</returns>
        public static ControlMeasureDataTypeArray FromItems(in Caers.Api.SchemaEntities.ControlMeasureDataType value1, in Caers.Api.SchemaEntities.ControlMeasureDataType value2, in Caers.Api.SchemaEntities.ControlMeasureDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ControlMeasureDataTypeArray FromItems(params Caers.Api.SchemaEntities.ControlMeasureDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.ControlMeasureDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ControlMeasureDataTypeArray FromRange(IEnumerable<Caers.Api.SchemaEntities.ControlMeasureDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.ControlMeasureDataType item in value)
            {
        ...
        /// </remarks>
        public static ControlMeasureDataTypeArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new ControlMeasureDataTypeArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ControlMeasureDataTypeArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ControlMeasureDataTypeArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.ControlMeasureDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.ControlMeasureDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.ControlMeasureDataType>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<ControlMeasureDataTypeArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<ControlMeasureDataTypeArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
