...
public readonly partial struct Emission
{
    ...
    /// </summary>
    public readonly partial struct EmissionFormulaVariableArray : IJsonArray<EmissionFormulaVariableArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly EmissionFormulaVariableArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "EmissionFormulaVariableArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public EmissionFormulaVariableArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public EmissionFormulaVariableArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(EmissionFormulaVariableArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator EmissionFormulaVariableArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(EmissionFormulaVariableArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator EmissionFormulaVariableArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static EmissionFormulaVariableArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A EmissionFormulaVariableArray instantiated from the given items.</returns>
        public static EmissionFormulaVariableArray FromItems(in Caers.Api.SchemaEntities.EmissionFormulaVariable value1)
        {
        ...
        /// <returns>A EmissionFormulaVariableArray instantiated from the given items.</returns>
        public static EmissionFormulaVariableArray FromItems(in Caers.Api.SchemaEntities.EmissionFormulaVariable value1, in Caers.Api.SchemaEntities.EmissionFormulaVariable value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A EmissionFormulaVariableArray instantiated from the given items.</returns>
        public static EmissionFormulaVariableArray FromItems(in Caers.Api.SchemaEntities.EmissionFormulaVariable value1, in Caers.Api.SchemaEntities.EmissionFormulaVariable value2, in Caers.Api.SchemaEntities.EmissionFormulaVariable value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static EmissionFormulaVariableArray FromItems(params Caers.Api.SchemaEntities.EmissionFormulaVariable[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.EmissionFormulaVariable item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static EmissionFormulaVariableArray FromRange(IEnumerable<Caers.Api.SchemaEntities.EmissionFormulaVariable> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.EmissionFormulaVariable item in value)
            {
        ...
        /// </remarks>
        public static EmissionFormulaVariableArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new EmissionFormulaVariableArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static EmissionFormulaVariableArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static EmissionFormulaVariableArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.EmissionFormulaVariable> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.EmissionFormulaVariable>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.EmissionFormulaVariable>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<EmissionFormulaVariableArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<EmissionFormulaVariableArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
