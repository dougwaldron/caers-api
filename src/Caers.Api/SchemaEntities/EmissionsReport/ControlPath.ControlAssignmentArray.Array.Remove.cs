...
public readonly partial struct ControlPath
{
    ...
    public readonly partial struct ControlAssignmentArray
    {
        ...
        public ControlAssignmentArray Remove(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ControlAssignmentArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ControlAssignmentArray RemoveRange(int index, int count)
        {
