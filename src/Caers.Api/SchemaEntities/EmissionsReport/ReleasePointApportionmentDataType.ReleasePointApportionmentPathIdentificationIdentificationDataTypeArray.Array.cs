...
public readonly partial struct ReleasePointApportionmentDataType
{
    ...
    /// </summary>
    public readonly partial struct ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray : IJsonArray<ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        ...
        public ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray instantiated from the given items.</returns>
        public static ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray FromItems(in Caers.Api.SchemaEntities.IdentificationDataType value1)
        {
        ...
        /// <returns>A ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray instantiated from the given items.</returns>
        public static ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray FromItems(in Caers.Api.SchemaEntities.IdentificationDataType value1, in Caers.Api.SchemaEntities.IdentificationDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray instantiated from the given items.</returns>
        public static ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray FromItems(in Caers.Api.SchemaEntities.IdentificationDataType value1, in Caers.Api.SchemaEntities.IdentificationDataType value2, in Caers.Api.SchemaEntities.IdentificationDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray FromItems(params Caers.Api.SchemaEntities.IdentificationDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.IdentificationDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray FromRange(IEnumerable<Caers.Api.SchemaEntities.IdentificationDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.IdentificationDataType item in value)
            {
        ...
        /// </remarks>
        public static ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.IdentificationDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.IdentificationDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.IdentificationDataType>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<ReleasePointApportionmentPathIdentificationIdentificationDataTypeArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
