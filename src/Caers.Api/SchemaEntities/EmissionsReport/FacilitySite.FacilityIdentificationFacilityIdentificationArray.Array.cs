...
public readonly partial struct FacilitySite
{
    ...
    /// </summary>
    public readonly partial struct FacilityIdentificationFacilityIdentificationArray : IJsonArray<FacilityIdentificationFacilityIdentificationArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly FacilityIdentificationFacilityIdentificationArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "FacilityIdentificationFacilityIdentificationArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public FacilityIdentificationFacilityIdentificationArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public FacilityIdentificationFacilityIdentificationArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(FacilityIdentificationFacilityIdentificationArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator FacilityIdentificationFacilityIdentificationArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(FacilityIdentificationFacilityIdentificationArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator FacilityIdentificationFacilityIdentificationArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static FacilityIdentificationFacilityIdentificationArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A FacilityIdentificationFacilityIdentificationArray instantiated from the given items.</returns>
        public static FacilityIdentificationFacilityIdentificationArray FromItems(in Caers.Api.SchemaEntities.FacilityIdentification value1)
        {
        ...
        /// <returns>A FacilityIdentificationFacilityIdentificationArray instantiated from the given items.</returns>
        public static FacilityIdentificationFacilityIdentificationArray FromItems(in Caers.Api.SchemaEntities.FacilityIdentification value1, in Caers.Api.SchemaEntities.FacilityIdentification value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A FacilityIdentificationFacilityIdentificationArray instantiated from the given items.</returns>
        public static FacilityIdentificationFacilityIdentificationArray FromItems(in Caers.Api.SchemaEntities.FacilityIdentification value1, in Caers.Api.SchemaEntities.FacilityIdentification value2, in Caers.Api.SchemaEntities.FacilityIdentification value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static FacilityIdentificationFacilityIdentificationArray FromItems(params Caers.Api.SchemaEntities.FacilityIdentification[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.FacilityIdentification item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static FacilityIdentificationFacilityIdentificationArray FromRange(IEnumerable<Caers.Api.SchemaEntities.FacilityIdentification> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.FacilityIdentification item in value)
            {
        ...
        /// </remarks>
        public static FacilityIdentificationFacilityIdentificationArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new FacilityIdentificationFacilityIdentificationArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static FacilityIdentificationFacilityIdentificationArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static FacilityIdentificationFacilityIdentificationArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.FacilityIdentification> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.FacilityIdentification>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.FacilityIdentification>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<FacilityIdentificationFacilityIdentificationArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<FacilityIdentificationFacilityIdentificationArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
