...
public readonly partial struct FacilitySite
{
    ...
    /// </summary>
    public readonly partial struct FacilityNACSFacilityNACSArray : IJsonArray<FacilityNACSFacilityNACSArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly FacilityNACSFacilityNACSArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "FacilityNACSFacilityNACSArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public FacilityNACSFacilityNACSArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public FacilityNACSFacilityNACSArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(FacilityNACSFacilityNACSArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator FacilityNACSFacilityNACSArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(FacilityNACSFacilityNACSArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator FacilityNACSFacilityNACSArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static FacilityNACSFacilityNACSArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A FacilityNACSFacilityNACSArray instantiated from the given items.</returns>
        public static FacilityNACSFacilityNACSArray FromItems(in Caers.Api.SchemaEntities.FacilityNACS value1)
        {
        ...
        /// <returns>A FacilityNACSFacilityNACSArray instantiated from the given items.</returns>
        public static FacilityNACSFacilityNACSArray FromItems(in Caers.Api.SchemaEntities.FacilityNACS value1, in Caers.Api.SchemaEntities.FacilityNACS value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A FacilityNACSFacilityNACSArray instantiated from the given items.</returns>
        public static FacilityNACSFacilityNACSArray FromItems(in Caers.Api.SchemaEntities.FacilityNACS value1, in Caers.Api.SchemaEntities.FacilityNACS value2, in Caers.Api.SchemaEntities.FacilityNACS value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static FacilityNACSFacilityNACSArray FromItems(params Caers.Api.SchemaEntities.FacilityNACS[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.FacilityNACS item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static FacilityNACSFacilityNACSArray FromRange(IEnumerable<Caers.Api.SchemaEntities.FacilityNACS> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.FacilityNACS item in value)
            {
        ...
        /// </remarks>
        public static FacilityNACSFacilityNACSArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new FacilityNACSFacilityNACSArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static FacilityNACSFacilityNACSArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static FacilityNACSFacilityNACSArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.FacilityNACS> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.FacilityNACS>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.FacilityNACS>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<FacilityNACSFacilityNACSArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<FacilityNACSFacilityNACSArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
