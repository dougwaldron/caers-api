...
public readonly partial struct Emission
{
    ...
    /// </summary>
    public readonly partial struct CommentEntity : IJsonString<CommentEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "CommentEntity"/> struct.
        /// </summary>
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public CommentEntity(in ReadOnlySpan<char> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public CommentEntity(in ReadOnlySpan<byte> utf8Value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.String;
        ...
        public static implicit operator JsonString(CommentEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator CommentEntity(JsonString value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator CommentEntity(string value)
        {
            return new(value);
        }
        ...
        public static implicit operator string (CommentEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator CommentEntity(ReadOnlySpan<char> value)
        {
            return new(value);
        }
        ...
        /// <param name = "value">The value from which to convert.</param>
        /// <exception cref = "InvalidOperationException">The value was not a string.</exception>
        public static implicit operator ReadOnlySpan<char>(CommentEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator CommentEntity(ReadOnlySpan<byte> value)
        {
            return new(value);
        }

        /// <summary>
        /// Concatenate two JSON values, producing an instance of the string type CommentEntity.
        /// </summary>
        ...
        public static CommentEntity Concatenate<T1, T2>(Span<byte> buffer, in T1 firstValue, in T2 secondValue)
        ...
        /// <summary>
        /// Concatenate three JSON values, producing an instance of the string type CommentEntity.
        /// </summary>
        /// <typeparam name = "T1">The type of the first value.</typeparam>
        /// <typeparam name = "T2">The type of the second value.</typeparam>
        ...
        /// <returns>An instance of this string type.</returns>
        public static CommentEntity Concatenate<T1, T2, T3>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue)
        ...
        /// <summary>
        /// Concatenate four JSON values, producing an instance of the string type CommentEntity.
        /// </summary>
        /// <typeparam name = "T1">The type of the first value.</typeparam>
        /// <typeparam name = "T2">The type of the second value.</typeparam>
        /// <typeparam name = "T3">The type of the third value.</typeparam>
        ...
        /// <returns>An instance of this string type.</returns>
        public static CommentEntity Concatenate<T1, T2, T3, T4>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue, in T4 fourthValue)
        ...
        /// <summary>
        /// Concatenate five JSON values, producing an instance of the string type CommentEntity.
        /// </summary>
        /// <typeparam name = "T1">The type of the first value.</typeparam>
        /// <typeparam name = "T2">The type of the second value.</typeparam>
        /// <typeparam name = "T3">The type of the third value.</typeparam>
        ...
        /// <returns>An instance of this string type.</returns>
        public static CommentEntity Concatenate<T1, T2, T3, T4, T5>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue, in T4 fourthValue, in T5 fifthValue)
        ...
        /// <summary>
        /// Concatenate six JSON values, producing an instance of the string type CommentEntity.
        /// </summary>
        /// <typeparam name = "T1">The type of the first value.</typeparam>
        /// <typeparam name = "T2">The type of the second value.</typeparam>
        /// <typeparam name = "T3">The type of the third value.</typeparam>
        ...
        /// <returns>An instance of this string type.</returns>
        public static CommentEntity Concatenate<T1, T2, T3, T4, T5, T6>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue, in T4 fourthValue, in T5 fifthValue, in T6 sixthValue)
        ...
        /// <summary>
        /// Concatenate seven JSON values, producing an instance of the string type CommentEntity.
        /// </summary>
        /// <typeparam name = "T1">The type of the first value.</typeparam>
        /// <typeparam name = "T2">The type of the second value.</typeparam>
        /// <typeparam name = "T3">The type of the third value.</typeparam>
        ...
        /// <returns>An instance of this string type.</returns>
        public static CommentEntity Concatenate<T1, T2, T3, T4, T5, T6, T7>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue, in T4 fourthValue, in T5 fifthValue, in T6 sixthValue, in T7 seventhValue)
        ...
        /// <summary>
        /// Concatenate eight JSON values, producing an instance of the string type CommentEntity.
        /// </summary>
        /// <typeparam name = "T1">The type of the first value.</typeparam>
        /// <typeparam name = "T2">The type of the second value.</typeparam>
        /// <typeparam name = "T3">The type of the third value.</typeparam>
        ...
        /// <returns>An instance of this string type.</returns>
        public static CommentEntity Concatenate<T1, T2, T3, T4, T5, T6, T7, T8>(Span<byte> buffer, in T1 firstValue, in T2 secondValue, in T3 thirdValue, in T4 fourthValue, in T5 fifthValue, in T6 sixthValue, in T7 seventhValue, in T8 eighthValue)
