...
public readonly partial struct Control
{
    ...
    /// </summary>
    public readonly partial struct ControlPollutantArray : IJsonArray<ControlPollutantArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly ControlPollutantArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "ControlPollutantArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ControlPollutantArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ControlPollutantArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(ControlPollutantArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ControlPollutantArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(ControlPollutantArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ControlPollutantArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static ControlPollutantArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A ControlPollutantArray instantiated from the given items.</returns>
        public static ControlPollutantArray FromItems(in Caers.Api.SchemaEntities.ControlPollutant value1)
        {
        ...
        /// <returns>A ControlPollutantArray instantiated from the given items.</returns>
        public static ControlPollutantArray FromItems(in Caers.Api.SchemaEntities.ControlPollutant value1, in Caers.Api.SchemaEntities.ControlPollutant value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ControlPollutantArray instantiated from the given items.</returns>
        public static ControlPollutantArray FromItems(in Caers.Api.SchemaEntities.ControlPollutant value1, in Caers.Api.SchemaEntities.ControlPollutant value2, in Caers.Api.SchemaEntities.ControlPollutant value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ControlPollutantArray FromItems(params Caers.Api.SchemaEntities.ControlPollutant[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.ControlPollutant item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ControlPollutantArray FromRange(IEnumerable<Caers.Api.SchemaEntities.ControlPollutant> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.ControlPollutant item in value)
            {
        ...
        /// </remarks>
        public static ControlPollutantArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new ControlPollutantArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ControlPollutantArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ControlPollutantArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.ControlPollutant> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.ControlPollutant>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.ControlPollutant>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<ControlPollutantArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<ControlPollutantArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
