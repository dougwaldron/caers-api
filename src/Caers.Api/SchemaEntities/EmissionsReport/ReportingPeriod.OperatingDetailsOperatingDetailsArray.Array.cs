...
public readonly partial struct ReportingPeriod
{
    ...
    /// </summary>
    public readonly partial struct OperatingDetailsOperatingDetailsArray : IJsonArray<OperatingDetailsOperatingDetailsArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly OperatingDetailsOperatingDetailsArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "OperatingDetailsOperatingDetailsArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public OperatingDetailsOperatingDetailsArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public OperatingDetailsOperatingDetailsArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(OperatingDetailsOperatingDetailsArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator OperatingDetailsOperatingDetailsArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(OperatingDetailsOperatingDetailsArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator OperatingDetailsOperatingDetailsArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static OperatingDetailsOperatingDetailsArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A OperatingDetailsOperatingDetailsArray instantiated from the given items.</returns>
        public static OperatingDetailsOperatingDetailsArray FromItems(in Caers.Api.SchemaEntities.OperatingDetails value1)
        {
        ...
        /// <returns>A OperatingDetailsOperatingDetailsArray instantiated from the given items.</returns>
        public static OperatingDetailsOperatingDetailsArray FromItems(in Caers.Api.SchemaEntities.OperatingDetails value1, in Caers.Api.SchemaEntities.OperatingDetails value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A OperatingDetailsOperatingDetailsArray instantiated from the given items.</returns>
        public static OperatingDetailsOperatingDetailsArray FromItems(in Caers.Api.SchemaEntities.OperatingDetails value1, in Caers.Api.SchemaEntities.OperatingDetails value2, in Caers.Api.SchemaEntities.OperatingDetails value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static OperatingDetailsOperatingDetailsArray FromItems(params Caers.Api.SchemaEntities.OperatingDetails[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.OperatingDetails item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static OperatingDetailsOperatingDetailsArray FromRange(IEnumerable<Caers.Api.SchemaEntities.OperatingDetails> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.OperatingDetails item in value)
            {
        ...
        /// </remarks>
        public static OperatingDetailsOperatingDetailsArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new OperatingDetailsOperatingDetailsArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static OperatingDetailsOperatingDetailsArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static OperatingDetailsOperatingDetailsArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.OperatingDetails> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.OperatingDetails>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.OperatingDetails>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<OperatingDetailsOperatingDetailsArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<OperatingDetailsOperatingDetailsArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
