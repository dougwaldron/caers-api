...
public readonly partial struct ControlAssignment
{
    ...
    /// </summary>
    public readonly partial struct ControlIdentificationIdentificationArray : IJsonArray<ControlIdentificationIdentificationArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly ControlIdentificationIdentificationArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "ControlIdentificationIdentificationArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ControlIdentificationIdentificationArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ControlIdentificationIdentificationArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(ControlIdentificationIdentificationArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ControlIdentificationIdentificationArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(ControlIdentificationIdentificationArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ControlIdentificationIdentificationArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static ControlIdentificationIdentificationArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A ControlIdentificationIdentificationArray instantiated from the given items.</returns>
        public static ControlIdentificationIdentificationArray FromItems(in Caers.Api.SchemaEntities.Identification value1)
        {
        ...
        /// <returns>A ControlIdentificationIdentificationArray instantiated from the given items.</returns>
        public static ControlIdentificationIdentificationArray FromItems(in Caers.Api.SchemaEntities.Identification value1, in Caers.Api.SchemaEntities.Identification value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ControlIdentificationIdentificationArray instantiated from the given items.</returns>
        public static ControlIdentificationIdentificationArray FromItems(in Caers.Api.SchemaEntities.Identification value1, in Caers.Api.SchemaEntities.Identification value2, in Caers.Api.SchemaEntities.Identification value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ControlIdentificationIdentificationArray FromItems(params Caers.Api.SchemaEntities.Identification[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.Identification item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ControlIdentificationIdentificationArray FromRange(IEnumerable<Caers.Api.SchemaEntities.Identification> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.Identification item in value)
            {
        ...
        /// </remarks>
        public static ControlIdentificationIdentificationArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new ControlIdentificationIdentificationArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ControlIdentificationIdentificationArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ControlIdentificationIdentificationArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.Identification> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.Identification>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.Identification>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<ControlIdentificationIdentificationArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<ControlIdentificationIdentificationArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
