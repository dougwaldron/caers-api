...
public readonly partial struct FacilitySite
{
    ...
    public readonly partial struct EmissionsUnitArray
    {
        ...
        public EmissionsUnitArray Remove(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public EmissionsUnitArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public EmissionsUnitArray RemoveRange(int index, int count)
        {
