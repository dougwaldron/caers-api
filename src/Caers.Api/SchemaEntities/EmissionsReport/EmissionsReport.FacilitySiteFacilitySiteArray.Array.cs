...
public readonly partial struct EmissionsReport
{
    ...
    /// </summary>
    public readonly partial struct FacilitySiteFacilitySiteArray : IJsonArray<FacilitySiteFacilitySiteArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly FacilitySiteFacilitySiteArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "FacilitySiteFacilitySiteArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public FacilitySiteFacilitySiteArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public FacilitySiteFacilitySiteArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(FacilitySiteFacilitySiteArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator FacilitySiteFacilitySiteArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(FacilitySiteFacilitySiteArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator FacilitySiteFacilitySiteArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static FacilitySiteFacilitySiteArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A FacilitySiteFacilitySiteArray instantiated from the given items.</returns>
        public static FacilitySiteFacilitySiteArray FromItems(in Caers.Api.SchemaEntities.FacilitySite value1)
        {
        ...
        /// <returns>A FacilitySiteFacilitySiteArray instantiated from the given items.</returns>
        public static FacilitySiteFacilitySiteArray FromItems(in Caers.Api.SchemaEntities.FacilitySite value1, in Caers.Api.SchemaEntities.FacilitySite value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A FacilitySiteFacilitySiteArray instantiated from the given items.</returns>
        public static FacilitySiteFacilitySiteArray FromItems(in Caers.Api.SchemaEntities.FacilitySite value1, in Caers.Api.SchemaEntities.FacilitySite value2, in Caers.Api.SchemaEntities.FacilitySite value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static FacilitySiteFacilitySiteArray FromItems(params Caers.Api.SchemaEntities.FacilitySite[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.FacilitySite item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static FacilitySiteFacilitySiteArray FromRange(IEnumerable<Caers.Api.SchemaEntities.FacilitySite> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SchemaEntities.FacilitySite item in value)
            {
        ...
        /// </remarks>
        public static FacilitySiteFacilitySiteArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new FacilitySiteFacilitySiteArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static FacilitySiteFacilitySiteArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static FacilitySiteFacilitySiteArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SchemaEntities.FacilitySite> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.FacilitySite>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SchemaEntities.FacilitySite>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<FacilitySiteFacilitySiteArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<FacilitySiteFacilitySiteArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
