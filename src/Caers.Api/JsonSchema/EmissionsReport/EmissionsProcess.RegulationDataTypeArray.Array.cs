...
public readonly partial struct EmissionsProcess
{
    ...
    public readonly partial struct RegulationDataTypeArray : IJsonArray<RegulationDataTypeArray>
    {
        ...
        public static RegulationDataTypeArray FromItems(in Caers.Api.RegulationDataType value1)
        {
        ...
        /// <returns>A RegulationDataTypeArray instantiated from the given items.</returns>
        public static RegulationDataTypeArray FromItems(in Caers.Api.RegulationDataType value1, in Caers.Api.RegulationDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A RegulationDataTypeArray instantiated from the given items.</returns>
        public static RegulationDataTypeArray FromItems(in Caers.Api.RegulationDataType value1, in Caers.Api.RegulationDataType value2, in Caers.Api.RegulationDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static RegulationDataTypeArray FromItems(params Caers.Api.RegulationDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.RegulationDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static RegulationDataTypeArray FromRange(IEnumerable<Caers.Api.RegulationDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.RegulationDataType item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.RegulationDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.RegulationDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.RegulationDataType>(this.arrayBacking);
            }
