...
public readonly partial struct EmissionsProcess
{
    ...
    public readonly partial struct ReportingPeriodArray : IJsonArray<ReportingPeriodArray>
    {
        ...
        public static ReportingPeriodArray FromItems(in Caers.Api.ReportingPeriod value1)
        {
        ...
        /// <returns>A ReportingPeriodArray instantiated from the given items.</returns>
        public static ReportingPeriodArray FromItems(in Caers.Api.ReportingPeriod value1, in Caers.Api.ReportingPeriod value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ReportingPeriodArray instantiated from the given items.</returns>
        public static ReportingPeriodArray FromItems(in Caers.Api.ReportingPeriod value1, in Caers.Api.ReportingPeriod value2, in Caers.Api.ReportingPeriod value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ReportingPeriodArray FromItems(params Caers.Api.ReportingPeriod[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ReportingPeriod item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ReportingPeriodArray FromRange(IEnumerable<Caers.Api.ReportingPeriod> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ReportingPeriod item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.ReportingPeriod> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ReportingPeriod>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ReportingPeriod>(this.arrayBacking);
            }
