...
public readonly partial struct ProcessDataType
{
    ...
    public readonly partial struct DeleteReportingPeriodDataTypeArray : IJsonArray<DeleteReportingPeriodDataTypeArray>
    {
        ...
        public static DeleteReportingPeriodDataTypeArray FromItems(in Caers.Api.DeleteReportingPeriodDataType value1)
        {
        ...
        /// <returns>A DeleteReportingPeriodDataTypeArray instantiated from the given items.</returns>
        public static DeleteReportingPeriodDataTypeArray FromItems(in Caers.Api.DeleteReportingPeriodDataType value1, in Caers.Api.DeleteReportingPeriodDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A DeleteReportingPeriodDataTypeArray instantiated from the given items.</returns>
        public static DeleteReportingPeriodDataTypeArray FromItems(in Caers.Api.DeleteReportingPeriodDataType value1, in Caers.Api.DeleteReportingPeriodDataType value2, in Caers.Api.DeleteReportingPeriodDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static DeleteReportingPeriodDataTypeArray FromItems(params Caers.Api.DeleteReportingPeriodDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.DeleteReportingPeriodDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static DeleteReportingPeriodDataTypeArray FromRange(IEnumerable<Caers.Api.DeleteReportingPeriodDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.DeleteReportingPeriodDataType item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.DeleteReportingPeriodDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.DeleteReportingPeriodDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.DeleteReportingPeriodDataType>(this.arrayBacking);
            }
