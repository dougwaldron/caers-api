...
public readonly partial struct EmissionsReport
{
    ...
    public readonly partial struct FacilitySiteFacilitySiteArray : IJsonArray<FacilitySiteFacilitySiteArray>
    {
        ...
        public static FacilitySiteFacilitySiteArray FromItems(in Caers.Api.FacilitySite value1)
        {
        ...
        /// <returns>A FacilitySiteFacilitySiteArray instantiated from the given items.</returns>
        public static FacilitySiteFacilitySiteArray FromItems(in Caers.Api.FacilitySite value1, in Caers.Api.FacilitySite value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A FacilitySiteFacilitySiteArray instantiated from the given items.</returns>
        public static FacilitySiteFacilitySiteArray FromItems(in Caers.Api.FacilitySite value1, in Caers.Api.FacilitySite value2, in Caers.Api.FacilitySite value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static FacilitySiteFacilitySiteArray FromItems(params Caers.Api.FacilitySite[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.FacilitySite item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static FacilitySiteFacilitySiteArray FromRange(IEnumerable<Caers.Api.FacilitySite> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.FacilitySite item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.FacilitySite> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.FacilitySite>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.FacilitySite>(this.arrayBacking);
            }
