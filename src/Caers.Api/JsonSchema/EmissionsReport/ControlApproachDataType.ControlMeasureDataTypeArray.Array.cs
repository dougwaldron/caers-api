...
public readonly partial struct ControlApproachDataType
{
    ...
    public readonly partial struct ControlMeasureDataTypeArray : IJsonArray<ControlMeasureDataTypeArray>
    {
        ...
        public static ControlMeasureDataTypeArray FromItems(in Caers.Api.ControlMeasureDataType value1)
        {
        ...
        /// <returns>A ControlMeasureDataTypeArray instantiated from the given items.</returns>
        public static ControlMeasureDataTypeArray FromItems(in Caers.Api.ControlMeasureDataType value1, in Caers.Api.ControlMeasureDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ControlMeasureDataTypeArray instantiated from the given items.</returns>
        public static ControlMeasureDataTypeArray FromItems(in Caers.Api.ControlMeasureDataType value1, in Caers.Api.ControlMeasureDataType value2, in Caers.Api.ControlMeasureDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ControlMeasureDataTypeArray FromItems(params Caers.Api.ControlMeasureDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ControlMeasureDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ControlMeasureDataTypeArray FromRange(IEnumerable<Caers.Api.ControlMeasureDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ControlMeasureDataType item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.ControlMeasureDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ControlMeasureDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ControlMeasureDataType>(this.arrayBacking);
            }
