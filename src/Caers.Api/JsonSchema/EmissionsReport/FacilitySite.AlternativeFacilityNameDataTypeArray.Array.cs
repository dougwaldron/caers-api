...
public readonly partial struct FacilitySite
{
    ...
    public readonly partial struct AlternativeFacilityNameDataTypeArray : IJsonArray<AlternativeFacilityNameDataTypeArray>
    {
        ...
        public static AlternativeFacilityNameDataTypeArray FromItems(in Caers.Api.AlternativeFacilityNameDataType value1)
        {
        ...
        /// <returns>A AlternativeFacilityNameDataTypeArray instantiated from the given items.</returns>
        public static AlternativeFacilityNameDataTypeArray FromItems(in Caers.Api.AlternativeFacilityNameDataType value1, in Caers.Api.AlternativeFacilityNameDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A AlternativeFacilityNameDataTypeArray instantiated from the given items.</returns>
        public static AlternativeFacilityNameDataTypeArray FromItems(in Caers.Api.AlternativeFacilityNameDataType value1, in Caers.Api.AlternativeFacilityNameDataType value2, in Caers.Api.AlternativeFacilityNameDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static AlternativeFacilityNameDataTypeArray FromItems(params Caers.Api.AlternativeFacilityNameDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.AlternativeFacilityNameDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static AlternativeFacilityNameDataTypeArray FromRange(IEnumerable<Caers.Api.AlternativeFacilityNameDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.AlternativeFacilityNameDataType item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.AlternativeFacilityNameDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.AlternativeFacilityNameDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.AlternativeFacilityNameDataType>(this.arrayBacking);
            }
