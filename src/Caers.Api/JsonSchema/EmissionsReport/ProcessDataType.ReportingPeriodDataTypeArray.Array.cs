...
public readonly partial struct ProcessDataType
{
    ...
    public readonly partial struct ReportingPeriodDataTypeArray : IJsonArray<ReportingPeriodDataTypeArray>
    {
        ...
        public static ReportingPeriodDataTypeArray FromItems(in Caers.Api.ReportingPeriodDataType value1)
        {
        ...
        /// <returns>A ReportingPeriodDataTypeArray instantiated from the given items.</returns>
        public static ReportingPeriodDataTypeArray FromItems(in Caers.Api.ReportingPeriodDataType value1, in Caers.Api.ReportingPeriodDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ReportingPeriodDataTypeArray instantiated from the given items.</returns>
        public static ReportingPeriodDataTypeArray FromItems(in Caers.Api.ReportingPeriodDataType value1, in Caers.Api.ReportingPeriodDataType value2, in Caers.Api.ReportingPeriodDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ReportingPeriodDataTypeArray FromItems(params Caers.Api.ReportingPeriodDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ReportingPeriodDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ReportingPeriodDataTypeArray FromRange(IEnumerable<Caers.Api.ReportingPeriodDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ReportingPeriodDataType item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.ReportingPeriodDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ReportingPeriodDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ReportingPeriodDataType>(this.arrayBacking);
            }
