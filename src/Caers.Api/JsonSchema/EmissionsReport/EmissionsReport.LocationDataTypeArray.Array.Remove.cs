...
public readonly partial struct EmissionsReport
{
    ...
    public readonly partial struct LocationDataTypeArray
    {
        ...
        public LocationDataTypeArray Remove(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LocationDataTypeArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public LocationDataTypeArray RemoveRange(int index, int count)
        {
