...
public readonly partial struct ReleasePointApportionmentDataType
{
    ...
    public readonly partial struct IdentificationDataTypeArray : IJsonArray<IdentificationDataTypeArray>
    {
        ...
        public static IdentificationDataTypeArray FromItems(in Caers.Api.IdentificationDataType value1)
        {
        ...
        /// <returns>A IdentificationDataTypeArray instantiated from the given items.</returns>
        public static IdentificationDataTypeArray FromItems(in Caers.Api.IdentificationDataType value1, in Caers.Api.IdentificationDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A IdentificationDataTypeArray instantiated from the given items.</returns>
        public static IdentificationDataTypeArray FromItems(in Caers.Api.IdentificationDataType value1, in Caers.Api.IdentificationDataType value2, in Caers.Api.IdentificationDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static IdentificationDataTypeArray FromItems(params Caers.Api.IdentificationDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static IdentificationDataTypeArray FromRange(IEnumerable<Caers.Api.IdentificationDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.IdentificationDataType item in value)
            {
