...
public readonly partial struct ControlPath
{
    ...
    public readonly partial struct ControlAssignmentArray : IJsonArray<ControlAssignmentArray>
    {
        ...
        public static ControlAssignmentArray FromItems(in Caers.Api.ControlAssignment value1)
        {
        ...
        /// <returns>A ControlAssignmentArray instantiated from the given items.</returns>
        public static ControlAssignmentArray FromItems(in Caers.Api.ControlAssignment value1, in Caers.Api.ControlAssignment value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ControlAssignmentArray instantiated from the given items.</returns>
        public static ControlAssignmentArray FromItems(in Caers.Api.ControlAssignment value1, in Caers.Api.ControlAssignment value2, in Caers.Api.ControlAssignment value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ControlAssignmentArray FromItems(params Caers.Api.ControlAssignment[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ControlAssignment item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ControlAssignmentArray FromRange(IEnumerable<Caers.Api.ControlAssignment> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ControlAssignment item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.ControlAssignment> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ControlAssignment>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ControlAssignment>(this.arrayBacking);
            }
