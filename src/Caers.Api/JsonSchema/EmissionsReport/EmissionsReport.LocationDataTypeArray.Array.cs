...
public readonly partial struct EmissionsReport
{
    ...
    public readonly partial struct LocationDataTypeArray : IJsonArray<LocationDataTypeArray>
    {
        ...
        public static LocationDataTypeArray FromItems(in Caers.Api.LocationDataType value1)
        {
        ...
        /// <returns>A LocationDataTypeArray instantiated from the given items.</returns>
        public static LocationDataTypeArray FromItems(in Caers.Api.LocationDataType value1, in Caers.Api.LocationDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A LocationDataTypeArray instantiated from the given items.</returns>
        public static LocationDataTypeArray FromItems(in Caers.Api.LocationDataType value1, in Caers.Api.LocationDataType value2, in Caers.Api.LocationDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static LocationDataTypeArray FromItems(params Caers.Api.LocationDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.LocationDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static LocationDataTypeArray FromRange(IEnumerable<Caers.Api.LocationDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.LocationDataType item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.LocationDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.LocationDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.LocationDataType>(this.arrayBacking);
            }
