...
public readonly partial struct EventDataType
{
    ...
    public readonly partial struct EventReportingPeriodDataTypeArray : IJsonArray<EventReportingPeriodDataTypeArray>
    {
        ...
        public static EventReportingPeriodDataTypeArray FromItems(in Caers.Api.EventReportingPeriodDataType value1)
        {
        ...
        /// <returns>A EventReportingPeriodDataTypeArray instantiated from the given items.</returns>
        public static EventReportingPeriodDataTypeArray FromItems(in Caers.Api.EventReportingPeriodDataType value1, in Caers.Api.EventReportingPeriodDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A EventReportingPeriodDataTypeArray instantiated from the given items.</returns>
        public static EventReportingPeriodDataTypeArray FromItems(in Caers.Api.EventReportingPeriodDataType value1, in Caers.Api.EventReportingPeriodDataType value2, in Caers.Api.EventReportingPeriodDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static EventReportingPeriodDataTypeArray FromItems(params Caers.Api.EventReportingPeriodDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.EventReportingPeriodDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static EventReportingPeriodDataTypeArray FromRange(IEnumerable<Caers.Api.EventReportingPeriodDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.EventReportingPeriodDataType item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.EventReportingPeriodDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.EventReportingPeriodDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.EventReportingPeriodDataType>(this.arrayBacking);
            }
