...
public readonly partial struct FacilitySite
{
    ...
    public readonly partial struct FacilityIdentificationFacilityIdentificationArray : IJsonArray<FacilityIdentificationFacilityIdentificationArray>
    {
        ...
        public static FacilityIdentificationFacilityIdentificationArray FromItems(in Caers.Api.FacilityIdentification value1)
        {
        ...
        /// <returns>A FacilityIdentificationFacilityIdentificationArray instantiated from the given items.</returns>
        public static FacilityIdentificationFacilityIdentificationArray FromItems(in Caers.Api.FacilityIdentification value1, in Caers.Api.FacilityIdentification value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A FacilityIdentificationFacilityIdentificationArray instantiated from the given items.</returns>
        public static FacilityIdentificationFacilityIdentificationArray FromItems(in Caers.Api.FacilityIdentification value1, in Caers.Api.FacilityIdentification value2, in Caers.Api.FacilityIdentification value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static FacilityIdentificationFacilityIdentificationArray FromItems(params Caers.Api.FacilityIdentification[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.FacilityIdentification item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static FacilityIdentificationFacilityIdentificationArray FromRange(IEnumerable<Caers.Api.FacilityIdentification> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.FacilityIdentification item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.FacilityIdentification> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.FacilityIdentification>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.FacilityIdentification>(this.arrayBacking);
            }
