...
public readonly partial struct EventEmissionsProcessDataType
{
    ...
    /// </summary>
    public Caers.Api.EventEmissionsProcessDataType.EmissionsDataTypeArray EventEmissionsProcessEmissions
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.EventEmissionsProcessDataType.EmissionsDataTypeArray(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.EventEmissionsProcessDataType.EmissionsDataTypeArray>();
                }
            }
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public EventEmissionsProcessDataType WithEventEmissionsProcessEmissions(in Caers.Api.EventEmissionsProcessDataType.EmissionsDataTypeArray value)
    {
    ...
    {
        return property.ValueAs<Caers.Api.EventEmissionsProcessDataType.EmissionsDataTypeArray>().Validate(validationContext, level);
    }
