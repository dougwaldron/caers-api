...
public readonly partial struct FacilitySite
{
    ...
    public readonly partial struct AddressArray : IJsonArray<AddressArray>
    {
        ...
        public static AddressArray FromItems(in Caers.Api.Address value1)
        {
        ...
        /// <returns>A AddressArray instantiated from the given items.</returns>
        public static AddressArray FromItems(in Caers.Api.Address value1, in Caers.Api.Address value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A AddressArray instantiated from the given items.</returns>
        public static AddressArray FromItems(in Caers.Api.Address value1, in Caers.Api.Address value2, in Caers.Api.Address value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static AddressArray FromItems(params Caers.Api.Address[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.Address item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static AddressArray FromRange(IEnumerable<Caers.Api.Address> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.Address item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.Address> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.Address>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.Address>(this.arrayBacking);
            }
