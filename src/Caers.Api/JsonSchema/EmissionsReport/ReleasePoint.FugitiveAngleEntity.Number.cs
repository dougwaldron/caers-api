...
public readonly partial struct ReleasePoint
{
    ...
    /// </summary>
    public readonly partial struct FugitiveAngleEntity : IJsonNumber<FugitiveAngleEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "FugitiveAngleEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public FugitiveAngleEntity(double value)
        {
        ...
        public static implicit operator JsonNumber(FugitiveAngleEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator FugitiveAngleEntity(JsonNumber value)
        {
        ...
        public static implicit operator FugitiveAngleEntity(double value)
        {
            return new(value);
        }
        ...
        public static implicit operator double (FugitiveAngleEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator FugitiveAngleEntity(float value)
        {
            return new(value);
        }
        ...
        public static implicit operator float (FugitiveAngleEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator FugitiveAngleEntity(int value)
        {
            return new(value);
        }
        ...
        public static implicit operator int (FugitiveAngleEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator FugitiveAngleEntity(long value)
        {
            return new(value);
        }
        ...
        public static implicit operator long (FugitiveAngleEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator FugitiveAngleEntity(uint value)
        {
            return new(value);
        }
        ...
        public static implicit operator uint (FugitiveAngleEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator FugitiveAngleEntity(ushort value)
        {
            return new(value);
        }
        ...
        public static implicit operator ushort (FugitiveAngleEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator FugitiveAngleEntity(ulong value)
        {
            return new(value);
        }
        ...
        public static implicit operator ulong (FugitiveAngleEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator FugitiveAngleEntity(byte value)
        {
            return new(value);
        }
        ...
        public static implicit operator byte (FugitiveAngleEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator FugitiveAngleEntity(sbyte value)
        {
            return new(value);
        }
        ...
        public static implicit operator sbyte (FugitiveAngleEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
