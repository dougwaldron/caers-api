...
public readonly partial struct FacilitySite
{
    ...
    public readonly partial struct ReleasePointArray : IJsonArray<ReleasePointArray>
    {
        ...
        public static ReleasePointArray FromItems(in Caers.Api.ReleasePoint value1)
        {
        ...
        /// <returns>A ReleasePointArray instantiated from the given items.</returns>
        public static ReleasePointArray FromItems(in Caers.Api.ReleasePoint value1, in Caers.Api.ReleasePoint value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ReleasePointArray instantiated from the given items.</returns>
        public static ReleasePointArray FromItems(in Caers.Api.ReleasePoint value1, in Caers.Api.ReleasePoint value2, in Caers.Api.ReleasePoint value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ReleasePointArray FromItems(params Caers.Api.ReleasePoint[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ReleasePoint item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ReleasePointArray FromRange(IEnumerable<Caers.Api.ReleasePoint> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ReleasePoint item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.ReleasePoint> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ReleasePoint>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ReleasePoint>(this.arrayBacking);
            }
