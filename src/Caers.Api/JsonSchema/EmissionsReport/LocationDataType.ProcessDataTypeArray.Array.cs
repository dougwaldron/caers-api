...
public readonly partial struct LocationDataType
{
    ...
    public readonly partial struct ProcessDataTypeArray : IJsonArray<ProcessDataTypeArray>
    {
        ...
        public static ProcessDataTypeArray FromItems(in Caers.Api.ProcessDataType value1)
        {
        ...
        /// <returns>A ProcessDataTypeArray instantiated from the given items.</returns>
        public static ProcessDataTypeArray FromItems(in Caers.Api.ProcessDataType value1, in Caers.Api.ProcessDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ProcessDataTypeArray instantiated from the given items.</returns>
        public static ProcessDataTypeArray FromItems(in Caers.Api.ProcessDataType value1, in Caers.Api.ProcessDataType value2, in Caers.Api.ProcessDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ProcessDataTypeArray FromItems(params Caers.Api.ProcessDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ProcessDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ProcessDataTypeArray FromRange(IEnumerable<Caers.Api.ProcessDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ProcessDataType item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.ProcessDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ProcessDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ProcessDataType>(this.arrayBacking);
            }
