...
public readonly partial struct ControlApproachDataType
{
    ...
    public readonly partial struct ControlPollutantDataTypeArray : IJsonArray<ControlPollutantDataTypeArray>
    {
        ...
        public static ControlPollutantDataTypeArray FromItems(in Caers.Api.ControlPollutantDataType value1)
        {
        ...
        /// <returns>A ControlPollutantDataTypeArray instantiated from the given items.</returns>
        public static ControlPollutantDataTypeArray FromItems(in Caers.Api.ControlPollutantDataType value1, in Caers.Api.ControlPollutantDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ControlPollutantDataTypeArray instantiated from the given items.</returns>
        public static ControlPollutantDataTypeArray FromItems(in Caers.Api.ControlPollutantDataType value1, in Caers.Api.ControlPollutantDataType value2, in Caers.Api.ControlPollutantDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ControlPollutantDataTypeArray FromItems(params Caers.Api.ControlPollutantDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ControlPollutantDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ControlPollutantDataTypeArray FromRange(IEnumerable<Caers.Api.ControlPollutantDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ControlPollutantDataType item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.ControlPollutantDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ControlPollutantDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ControlPollutantDataType>(this.arrayBacking);
            }
