...
public readonly partial struct Country
{
    ...
    /// Gets Code.
    /// </summary>
    public Caers.Api.Country.CodeEntity Code
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.Country.CodeEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.Country.CodeEntity>();
                }
            }
    ...
    /// </summary>
    public static Country Create(Caers.Api.Country.CodeEntity? code = null, Corvus.Json.JsonString? name = null)
    {
        var builder = ImmutableDictionary.CreateBuilder<JsonPropertyName, JsonAny>();
        if (code is Caers.Api.Country.CodeEntity code__)
        {
    ...
    public Country WithCode(in Caers.Api.Country.CodeEntity value)
    {
    ...
    {
        return property.ValueAs<Caers.Api.Country.CodeEntity>().Validate(validationContext, level);
    }
