...
public readonly partial struct Emission
{
    ...
    public readonly partial struct EmissionFormulaVariableArray : IJsonArray<EmissionFormulaVariableArray>
    {
        ...
        public static EmissionFormulaVariableArray FromItems(in Caers.Api.EmissionFormulaVariable value1)
        {
        ...
        /// <returns>A EmissionFormulaVariableArray instantiated from the given items.</returns>
        public static EmissionFormulaVariableArray FromItems(in Caers.Api.EmissionFormulaVariable value1, in Caers.Api.EmissionFormulaVariable value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A EmissionFormulaVariableArray instantiated from the given items.</returns>
        public static EmissionFormulaVariableArray FromItems(in Caers.Api.EmissionFormulaVariable value1, in Caers.Api.EmissionFormulaVariable value2, in Caers.Api.EmissionFormulaVariable value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static EmissionFormulaVariableArray FromItems(params Caers.Api.EmissionFormulaVariable[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.EmissionFormulaVariable item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static EmissionFormulaVariableArray FromRange(IEnumerable<Caers.Api.EmissionFormulaVariable> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.EmissionFormulaVariable item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.EmissionFormulaVariable> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.EmissionFormulaVariable>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.EmissionFormulaVariable>(this.arrayBacking);
            }
