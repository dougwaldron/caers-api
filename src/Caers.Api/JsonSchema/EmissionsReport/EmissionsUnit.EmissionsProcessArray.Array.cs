...
public readonly partial struct EmissionsUnit
{
    ...
    public readonly partial struct EmissionsProcessArray : IJsonArray<EmissionsProcessArray>
    {
        ...
        public static EmissionsProcessArray FromItems(in Caers.Api.EmissionsProcess value1)
        {
        ...
        /// <returns>A EmissionsProcessArray instantiated from the given items.</returns>
        public static EmissionsProcessArray FromItems(in Caers.Api.EmissionsProcess value1, in Caers.Api.EmissionsProcess value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A EmissionsProcessArray instantiated from the given items.</returns>
        public static EmissionsProcessArray FromItems(in Caers.Api.EmissionsProcess value1, in Caers.Api.EmissionsProcess value2, in Caers.Api.EmissionsProcess value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static EmissionsProcessArray FromItems(params Caers.Api.EmissionsProcess[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.EmissionsProcess item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static EmissionsProcessArray FromRange(IEnumerable<Caers.Api.EmissionsProcess> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.EmissionsProcess item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.EmissionsProcess> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.EmissionsProcess>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.EmissionsProcess>(this.arrayBacking);
            }
