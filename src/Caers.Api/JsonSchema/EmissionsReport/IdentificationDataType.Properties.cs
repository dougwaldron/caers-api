...
public readonly partial struct IdentificationDataType
{
    ...
    /// <summary>
    /// Creates an instance of a <see cref = "IdentificationDataType"/>.
    /// </summary>
    public static IdentificationDataType Create(Corvus.Json.JsonString identifier, Corvus.Json.JsonString programSystemCode, Corvus.Json.JsonDateTime? effectiveDate = null, Corvus.Json.JsonDateTime? endDate = null, Corvus.Json.JsonString? identifierIsReadOnly = null)
    {
    ...
    public IdentificationDataType WithEffectiveDate(in Corvus.Json.JsonDateTime value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public IdentificationDataType WithEndDate(in Corvus.Json.JsonDateTime value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public IdentificationDataType WithIdentifier(in Corvus.Json.JsonString value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public IdentificationDataType WithIdentifierIsReadOnly(in Corvus.Json.JsonString value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public IdentificationDataType WithProgramSystemCode(in Corvus.Json.JsonString value)
    {
