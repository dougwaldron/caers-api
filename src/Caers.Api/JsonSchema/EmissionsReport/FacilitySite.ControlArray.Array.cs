...
public readonly partial struct FacilitySite
{
    ...
    public readonly partial struct ControlArray : IJsonArray<ControlArray>
    {
        ...
        public static ControlArray FromItems(in Caers.Api.Control value1)
        {
        ...
        /// <returns>A ControlArray instantiated from the given items.</returns>
        public static ControlArray FromItems(in Caers.Api.Control value1, in Caers.Api.Control value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ControlArray instantiated from the given items.</returns>
        public static ControlArray FromItems(in Caers.Api.Control value1, in Caers.Api.Control value2, in Caers.Api.Control value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ControlArray FromItems(params Caers.Api.Control[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.Control item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ControlArray FromRange(IEnumerable<Caers.Api.Control> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.Control item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.Control> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.Control>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.Control>(this.arrayBacking);
            }
