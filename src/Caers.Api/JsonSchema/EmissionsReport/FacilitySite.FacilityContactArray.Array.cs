...
public readonly partial struct FacilitySite
{
    ...
    public readonly partial struct FacilityContactArray : IJsonArray<FacilityContactArray>
    {
        ...
        public static FacilityContactArray FromItems(in Caers.Api.FacilityContact value1)
        {
        ...
        /// <returns>A FacilityContactArray instantiated from the given items.</returns>
        public static FacilityContactArray FromItems(in Caers.Api.FacilityContact value1, in Caers.Api.FacilityContact value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A FacilityContactArray instantiated from the given items.</returns>
        public static FacilityContactArray FromItems(in Caers.Api.FacilityContact value1, in Caers.Api.FacilityContact value2, in Caers.Api.FacilityContact value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static FacilityContactArray FromItems(params Caers.Api.FacilityContact[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.FacilityContact item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static FacilityContactArray FromRange(IEnumerable<Caers.Api.FacilityContact> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.FacilityContact item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.FacilityContact> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.FacilityContact>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.FacilityContact>(this.arrayBacking);
            }
