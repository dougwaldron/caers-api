...
public readonly partial struct AlternativeFacilityIdentification
{
    ...
    /// Gets Identifier.
    /// </summary>
    public Caers.Api.AlternativeFacilityIdentification.IdentifierEntity Identifier
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.AlternativeFacilityIdentification.IdentifierEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.AlternativeFacilityIdentification.IdentifierEntity>();
                }
            }
    ...
    /// </summary>
    public Caers.Api.AlternativeFacilityIdentification.ProgramSystemCodeEntity ProgramSystemCode
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.AlternativeFacilityIdentification.ProgramSystemCodeEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.AlternativeFacilityIdentification.ProgramSystemCodeEntity>();
                }
            }
    ...
    /// </summary>
    public static AlternativeFacilityIdentification Create(Caers.Api.AlternativeFacilityIdentification.IdentifierEntity identifier, Corvus.Json.JsonDate? effectiveDate = null, Corvus.Json.JsonDate? endDate = null, Corvus.Json.JsonString? identifierIsReadOnly = null, Caers.Api.AlternativeFacilityIdentification.ProgramSystemCodeEntity? programSystemCode = null, Corvus.Json.JsonString? type = null)
    {
        ...
        if (programSystemCode is Caers.Api.AlternativeFacilityIdentification.ProgramSystemCodeEntity programSystemCode__)
        {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public AlternativeFacilityIdentification WithIdentifier(in Caers.Api.AlternativeFacilityIdentification.IdentifierEntity value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public AlternativeFacilityIdentification WithProgramSystemCode(in Caers.Api.AlternativeFacilityIdentification.ProgramSystemCodeEntity value)
    {
    ...
    {
        return property.ValueAs<Caers.Api.AlternativeFacilityIdentification.IdentifierEntity>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<Caers.Api.AlternativeFacilityIdentification.ProgramSystemCodeEntity>().Validate(validationContext, level);
    }
