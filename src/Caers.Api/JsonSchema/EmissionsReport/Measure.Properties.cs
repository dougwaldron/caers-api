...
public readonly partial struct Measure
{
    ...
    /// Gets Unit.
    /// </summary>
    public Caers.Api.MeasureUnit Unit
    {
        get
        {
    ...
    /// </summary>
    public static Measure Create(Caers.Api.MeasureUnit unit, Corvus.Json.JsonNumber value)
    {
    ...
    public Measure WithUnit(in Caers.Api.MeasureUnit value)
    {
