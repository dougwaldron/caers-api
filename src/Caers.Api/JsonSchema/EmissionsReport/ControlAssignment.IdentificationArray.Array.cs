...
public readonly partial struct ControlAssignment
{
    ...
    public readonly partial struct IdentificationArray : IJsonArray<IdentificationArray>
    {
        ...
        public static IdentificationArray FromItems(in Caers.Api.Identification value1)
        {
        ...
        /// <returns>A IdentificationArray instantiated from the given items.</returns>
        public static IdentificationArray FromItems(in Caers.Api.Identification value1, in Caers.Api.Identification value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A IdentificationArray instantiated from the given items.</returns>
        public static IdentificationArray FromItems(in Caers.Api.Identification value1, in Caers.Api.Identification value2, in Caers.Api.Identification value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static IdentificationArray FromItems(params Caers.Api.Identification[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static IdentificationArray FromRange(IEnumerable<Caers.Api.Identification> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.Identification item in value)
            {
