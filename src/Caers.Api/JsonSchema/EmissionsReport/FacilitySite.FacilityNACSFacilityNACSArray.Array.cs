...
public readonly partial struct FacilitySite
{
    ...
    public readonly partial struct FacilityNACSFacilityNACSArray : IJsonArray<FacilityNACSFacilityNACSArray>
    {
        ...
        public static FacilityNACSFacilityNACSArray FromItems(in Caers.Api.FacilityNACS value1)
        {
        ...
        /// <returns>A FacilityNACSFacilityNACSArray instantiated from the given items.</returns>
        public static FacilityNACSFacilityNACSArray FromItems(in Caers.Api.FacilityNACS value1, in Caers.Api.FacilityNACS value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A FacilityNACSFacilityNACSArray instantiated from the given items.</returns>
        public static FacilityNACSFacilityNACSArray FromItems(in Caers.Api.FacilityNACS value1, in Caers.Api.FacilityNACS value2, in Caers.Api.FacilityNACS value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static FacilityNACSFacilityNACSArray FromItems(params Caers.Api.FacilityNACS[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.FacilityNACS item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static FacilityNACSFacilityNACSArray FromRange(IEnumerable<Caers.Api.FacilityNACS> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.FacilityNACS item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.FacilityNACS> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.FacilityNACS>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.FacilityNACS>(this.arrayBacking);
            }
