...
public readonly partial struct ReleasePointApportionmentDataType
{
    ...
    public readonly partial struct ReleasePointApportionmentIdentificationIdentificationDataTypeArray
    {
        ...
        public ReleasePointApportionmentIdentificationIdentificationDataTypeArray Remove(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ReleasePointApportionmentIdentificationIdentificationDataTypeArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ReleasePointApportionmentIdentificationIdentificationDataTypeArray RemoveRange(int index, int count)
        {
