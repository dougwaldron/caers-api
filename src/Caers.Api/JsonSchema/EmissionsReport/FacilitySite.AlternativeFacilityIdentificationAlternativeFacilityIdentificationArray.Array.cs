...
public readonly partial struct FacilitySite
{
    ...
    public readonly partial struct AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray : IJsonArray<AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray>
    {
        ...
        public static AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray FromItems(in Caers.Api.AlternativeFacilityIdentification value1)
        {
        ...
        /// <returns>A AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray instantiated from the given items.</returns>
        public static AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray FromItems(in Caers.Api.AlternativeFacilityIdentification value1, in Caers.Api.AlternativeFacilityIdentification value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray instantiated from the given items.</returns>
        public static AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray FromItems(in Caers.Api.AlternativeFacilityIdentification value1, in Caers.Api.AlternativeFacilityIdentification value2, in Caers.Api.AlternativeFacilityIdentification value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray FromItems(params Caers.Api.AlternativeFacilityIdentification[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.AlternativeFacilityIdentification item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static AlternativeFacilityIdentificationAlternativeFacilityIdentificationArray FromRange(IEnumerable<Caers.Api.AlternativeFacilityIdentification> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.AlternativeFacilityIdentification item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.AlternativeFacilityIdentification> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.AlternativeFacilityIdentification>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.AlternativeFacilityIdentification>(this.arrayBacking);
            }
