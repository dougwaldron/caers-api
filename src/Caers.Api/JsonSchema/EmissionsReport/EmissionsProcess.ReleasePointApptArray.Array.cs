...
public readonly partial struct EmissionsProcess
{
    ...
    public readonly partial struct ReleasePointApptArray : IJsonArray<ReleasePointApptArray>
    {
        ...
        public static ReleasePointApptArray FromItems(in Caers.Api.ReleasePointAppt value1)
        {
        ...
        /// <returns>A ReleasePointApptArray instantiated from the given items.</returns>
        public static ReleasePointApptArray FromItems(in Caers.Api.ReleasePointAppt value1, in Caers.Api.ReleasePointAppt value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ReleasePointApptArray instantiated from the given items.</returns>
        public static ReleasePointApptArray FromItems(in Caers.Api.ReleasePointAppt value1, in Caers.Api.ReleasePointAppt value2, in Caers.Api.ReleasePointAppt value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ReleasePointApptArray FromItems(params Caers.Api.ReleasePointAppt[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ReleasePointAppt item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ReleasePointApptArray FromRange(IEnumerable<Caers.Api.ReleasePointAppt> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ReleasePointAppt item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.ReleasePointAppt> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ReleasePointAppt>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ReleasePointAppt>(this.arrayBacking);
            }
