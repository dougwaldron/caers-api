...
public readonly partial struct FacilitySite
{
    ...
    public readonly partial struct EmissionsUnitArray : IJsonArray<EmissionsUnitArray>
    {
        ...
        public static EmissionsUnitArray FromItems(in Caers.Api.EmissionsUnit value1)
        {
        ...
        /// <returns>A EmissionsUnitArray instantiated from the given items.</returns>
        public static EmissionsUnitArray FromItems(in Caers.Api.EmissionsUnit value1, in Caers.Api.EmissionsUnit value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A EmissionsUnitArray instantiated from the given items.</returns>
        public static EmissionsUnitArray FromItems(in Caers.Api.EmissionsUnit value1, in Caers.Api.EmissionsUnit value2, in Caers.Api.EmissionsUnit value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static EmissionsUnitArray FromItems(params Caers.Api.EmissionsUnit[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.EmissionsUnit item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static EmissionsUnitArray FromRange(IEnumerable<Caers.Api.EmissionsUnit> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.EmissionsUnit item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.EmissionsUnit> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.EmissionsUnit>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.EmissionsUnit>(this.arrayBacking);
            }
