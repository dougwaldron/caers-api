...
public readonly partial struct ReportingPeriodDataType
{
    ...
    public readonly partial struct SupplementalCalculationParameterDataTypeArray : IJsonArray<SupplementalCalculationParameterDataTypeArray>
    {
        ...
        public static SupplementalCalculationParameterDataTypeArray FromItems(in Caers.Api.SupplementalCalculationParameterDataType value1)
        {
        ...
        /// <returns>A SupplementalCalculationParameterDataTypeArray instantiated from the given items.</returns>
        public static SupplementalCalculationParameterDataTypeArray FromItems(in Caers.Api.SupplementalCalculationParameterDataType value1, in Caers.Api.SupplementalCalculationParameterDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A SupplementalCalculationParameterDataTypeArray instantiated from the given items.</returns>
        public static SupplementalCalculationParameterDataTypeArray FromItems(in Caers.Api.SupplementalCalculationParameterDataType value1, in Caers.Api.SupplementalCalculationParameterDataType value2, in Caers.Api.SupplementalCalculationParameterDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static SupplementalCalculationParameterDataTypeArray FromItems(params Caers.Api.SupplementalCalculationParameterDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SupplementalCalculationParameterDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static SupplementalCalculationParameterDataTypeArray FromRange(IEnumerable<Caers.Api.SupplementalCalculationParameterDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.SupplementalCalculationParameterDataType item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.SupplementalCalculationParameterDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SupplementalCalculationParameterDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.SupplementalCalculationParameterDataType>(this.arrayBacking);
            }
