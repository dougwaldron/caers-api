...
public readonly partial struct EmissionsReport
{
    ...
    public readonly partial struct EventDataTypeArray
    {
        ...
        public EventDataTypeArray Remove(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public EventDataTypeArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public EventDataTypeArray RemoveRange(int index, int count)
        {
