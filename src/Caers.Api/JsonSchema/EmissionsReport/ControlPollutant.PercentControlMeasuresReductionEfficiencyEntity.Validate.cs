    ...
    public readonly partial struct PercentControlMeasuresReductionEfficiencyEntity
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("D:/projects/Caers.Api/Caers.Api/JsonSchema/caers-report-openapi.json#/components/schemas/ControlPollutant/properties/percentControlMeasuresReductionEfficiency");
            }
