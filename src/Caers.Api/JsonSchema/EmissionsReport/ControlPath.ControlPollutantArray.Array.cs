...
public readonly partial struct ControlPath
{
    ...
    public readonly partial struct ControlPollutantArray : IJsonArray<ControlPollutantArray>
    {
        ...
        public static ControlPollutantArray FromItems(in Caers.Api.ControlPollutant value1)
        {
        ...
        /// <returns>A ControlPollutantArray instantiated from the given items.</returns>
        public static ControlPollutantArray FromItems(in Caers.Api.ControlPollutant value1, in Caers.Api.ControlPollutant value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ControlPollutantArray instantiated from the given items.</returns>
        public static ControlPollutantArray FromItems(in Caers.Api.ControlPollutant value1, in Caers.Api.ControlPollutant value2, in Caers.Api.ControlPollutant value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ControlPollutantArray FromItems(params Caers.Api.ControlPollutant[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ControlPollutant item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ControlPollutantArray FromRange(IEnumerable<Caers.Api.ControlPollutant> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ControlPollutant item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.ControlPollutant> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ControlPollutant>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ControlPollutant>(this.arrayBacking);
            }
