...
public readonly partial struct EventLocationDataType
{
    ...
    public readonly partial struct EventEmissionsProcessDataTypeArray : IJsonArray<EventEmissionsProcessDataTypeArray>
    {
        ...
        public static EventEmissionsProcessDataTypeArray FromItems(in Caers.Api.EventEmissionsProcessDataType value1)
        {
        ...
        /// <returns>A EventEmissionsProcessDataTypeArray instantiated from the given items.</returns>
        public static EventEmissionsProcessDataTypeArray FromItems(in Caers.Api.EventEmissionsProcessDataType value1, in Caers.Api.EventEmissionsProcessDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A EventEmissionsProcessDataTypeArray instantiated from the given items.</returns>
        public static EventEmissionsProcessDataTypeArray FromItems(in Caers.Api.EventEmissionsProcessDataType value1, in Caers.Api.EventEmissionsProcessDataType value2, in Caers.Api.EventEmissionsProcessDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static EventEmissionsProcessDataTypeArray FromItems(params Caers.Api.EventEmissionsProcessDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.EventEmissionsProcessDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static EventEmissionsProcessDataTypeArray FromRange(IEnumerable<Caers.Api.EventEmissionsProcessDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.EventEmissionsProcessDataType item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.EventEmissionsProcessDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.EventEmissionsProcessDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.EventEmissionsProcessDataType>(this.arrayBacking);
            }
