...
public readonly partial struct ReleasePointApportionmentDataType
{
    ...
    /// </summary>
    public readonly partial struct ReleasePointApportionmentIdentificationIdentificationDataTypeArray : IJsonArray<ReleasePointApportionmentIdentificationIdentificationDataTypeArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly ReleasePointApportionmentIdentificationIdentificationDataTypeArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        ...
        public ReleasePointApportionmentIdentificationIdentificationDataTypeArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ReleasePointApportionmentIdentificationIdentificationDataTypeArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(ReleasePointApportionmentIdentificationIdentificationDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ReleasePointApportionmentIdentificationIdentificationDataTypeArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(ReleasePointApportionmentIdentificationIdentificationDataTypeArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ReleasePointApportionmentIdentificationIdentificationDataTypeArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static ReleasePointApportionmentIdentificationIdentificationDataTypeArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A ReleasePointApportionmentIdentificationIdentificationDataTypeArray instantiated from the given items.</returns>
        public static ReleasePointApportionmentIdentificationIdentificationDataTypeArray FromItems(in Caers.Api.IdentificationDataType value1)
        {
        ...
        /// <returns>A ReleasePointApportionmentIdentificationIdentificationDataTypeArray instantiated from the given items.</returns>
        public static ReleasePointApportionmentIdentificationIdentificationDataTypeArray FromItems(in Caers.Api.IdentificationDataType value1, in Caers.Api.IdentificationDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ReleasePointApportionmentIdentificationIdentificationDataTypeArray instantiated from the given items.</returns>
        public static ReleasePointApportionmentIdentificationIdentificationDataTypeArray FromItems(in Caers.Api.IdentificationDataType value1, in Caers.Api.IdentificationDataType value2, in Caers.Api.IdentificationDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ReleasePointApportionmentIdentificationIdentificationDataTypeArray FromItems(params Caers.Api.IdentificationDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.IdentificationDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ReleasePointApportionmentIdentificationIdentificationDataTypeArray FromRange(IEnumerable<Caers.Api.IdentificationDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.IdentificationDataType item in value)
            {
        ...
        /// </remarks>
        public static ReleasePointApportionmentIdentificationIdentificationDataTypeArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new ReleasePointApportionmentIdentificationIdentificationDataTypeArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ReleasePointApportionmentIdentificationIdentificationDataTypeArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ReleasePointApportionmentIdentificationIdentificationDataTypeArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.IdentificationDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.IdentificationDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.IdentificationDataType>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<ReleasePointApportionmentIdentificationIdentificationDataTypeArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<ReleasePointApportionmentIdentificationIdentificationDataTypeArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
