...
public readonly partial struct Identification
{
    ...
    /// Gets Identifier.
    /// </summary>
    public Caers.Api.Identification.IdentifierEntity Identifier
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.Identification.IdentifierEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.Identification.IdentifierEntity>();
                }
            }
    ...
    /// </summary>
    public Caers.Api.Identification.ProgramSystemCodeEntity ProgramSystemCode
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.Identification.ProgramSystemCodeEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.Identification.ProgramSystemCodeEntity>();
                }
            }
    ...
    /// </summary>
    public static Identification Create(Caers.Api.Identification.IdentifierEntity identifier, Corvus.Json.JsonDate? effectiveDate = null, Corvus.Json.JsonDate? endDate = null, Corvus.Json.JsonString? identifierIsReadOnly = null, Caers.Api.Identification.ProgramSystemCodeEntity? programSystemCode = null)
    {
        ...
        if (programSystemCode is Caers.Api.Identification.ProgramSystemCodeEntity programSystemCode__)
        {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public Identification WithIdentifier(in Caers.Api.Identification.IdentifierEntity value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public Identification WithProgramSystemCode(in Caers.Api.Identification.ProgramSystemCodeEntity value)
    {
    ...
    {
        return property.ValueAs<Caers.Api.Identification.IdentifierEntity>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<Caers.Api.Identification.ProgramSystemCodeEntity>().Validate(validationContext, level);
    }
