...
public readonly partial struct ReportingPeriod
{
    ...
    public readonly partial struct EmissionArray : IJsonArray<EmissionArray>
    {
        ...
        public static EmissionArray FromItems(in Caers.Api.Emission value1)
        {
        ...
        /// <returns>A EmissionArray instantiated from the given items.</returns>
        public static EmissionArray FromItems(in Caers.Api.Emission value1, in Caers.Api.Emission value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A EmissionArray instantiated from the given items.</returns>
        public static EmissionArray FromItems(in Caers.Api.Emission value1, in Caers.Api.Emission value2, in Caers.Api.Emission value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static EmissionArray FromItems(params Caers.Api.Emission[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.Emission item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static EmissionArray FromRange(IEnumerable<Caers.Api.Emission> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.Emission item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.Emission> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.Emission>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.Emission>(this.arrayBacking);
            }
