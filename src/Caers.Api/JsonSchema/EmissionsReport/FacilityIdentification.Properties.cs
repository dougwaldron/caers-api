...
public readonly partial struct FacilityIdentification
{
    ...
    /// Gets Identifier.
    /// </summary>
    public Caers.Api.FacilityIdentification.IdentifierEntity Identifier
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.FacilityIdentification.IdentifierEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.FacilityIdentification.IdentifierEntity>();
                }
            }
    ...
    /// </summary>
    public Caers.Api.FacilityIdentification.ProgramSystemCodeEntity ProgramSystemCode
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.FacilityIdentification.ProgramSystemCodeEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.FacilityIdentification.ProgramSystemCodeEntity>();
                }
            }
    ...
    /// Gets TribalCode.
    /// </summary>
    public Caers.Api.LookupValue TribalCode
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
    ...
    /// </summary>
    public static FacilityIdentification Create(Caers.Api.FacilityIdentification.IdentifierEntity identifier, Corvus.Json.JsonDate? effectiveDate = null, Corvus.Json.JsonDate? endDate = null, Corvus.Json.JsonString? identifierIsReadOnly = null, Caers.Api.FacilityIdentification.ProgramSystemCodeEntity? programSystemCode = null, Corvus.Json.JsonString? stateAndCountryFICode = null, Corvus.Json.JsonString? stateAndCountyFICode = null, Caers.Api.LookupValue? tribalCode = null)
    {
        ...
        if (programSystemCode is Caers.Api.FacilityIdentification.ProgramSystemCodeEntity programSystemCode__)
        {
        ...
        if (tribalCode is Caers.Api.LookupValue tribalCode__)
        {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public FacilityIdentification WithIdentifier(in Caers.Api.FacilityIdentification.IdentifierEntity value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public FacilityIdentification WithProgramSystemCode(in Caers.Api.FacilityIdentification.ProgramSystemCodeEntity value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public FacilityIdentification WithTribalCode(in Caers.Api.LookupValue value)
    {
    ...
    {
        return property.ValueAs<Caers.Api.FacilityIdentification.IdentifierEntity>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<Caers.Api.FacilityIdentification.ProgramSystemCodeEntity>().Validate(validationContext, level);
    }
