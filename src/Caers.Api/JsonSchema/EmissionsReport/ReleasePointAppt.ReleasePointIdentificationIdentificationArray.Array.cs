...
public readonly partial struct ReleasePointAppt
{
    ...
    /// </summary>
    public readonly partial struct ReleasePointIdentificationIdentificationArray : IJsonArray<ReleasePointIdentificationIdentificationArray>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static readonly ReleasePointIdentificationIdentificationArray EmptyArray = From(ImmutableList<JsonAny>.Empty);
        /// <summary>
        /// Initializes a new instance of the <see cref = "ReleasePointIdentificationIdentificationArray"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ReleasePointIdentificationIdentificationArray(ImmutableList<JsonAny> value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public ReleasePointIdentificationIdentificationArray(IEnumerable<JsonAny> value)
        {
            this.jsonElementBacking = default;
            this.backing = Backing.Array;
        ...
        public static implicit operator JsonArray(ReleasePointIdentificationIdentificationArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ReleasePointIdentificationIdentificationArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(ReleasePointIdentificationIdentificationArray value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator ReleasePointIdentificationIdentificationArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        public static ReleasePointIdentificationIdentificationArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }
        ...
        /// <returns>A ReleasePointIdentificationIdentificationArray instantiated from the given items.</returns>
        public static ReleasePointIdentificationIdentificationArray FromItems(in Caers.Api.Identification value1)
        {
        ...
        /// <returns>A ReleasePointIdentificationIdentificationArray instantiated from the given items.</returns>
        public static ReleasePointIdentificationIdentificationArray FromItems(in Caers.Api.Identification value1, in Caers.Api.Identification value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ReleasePointIdentificationIdentificationArray instantiated from the given items.</returns>
        public static ReleasePointIdentificationIdentificationArray FromItems(in Caers.Api.Identification value1, in Caers.Api.Identification value2, in Caers.Api.Identification value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ReleasePointIdentificationIdentificationArray FromItems(params Caers.Api.Identification[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.Identification item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ReleasePointIdentificationIdentificationArray FromRange(IEnumerable<Caers.Api.Identification> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.Identification item in value)
            {
        ...
        /// </remarks>
        public static ReleasePointIdentificationIdentificationArray From<T>(IEnumerable<T> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            ...
            return new ReleasePointIdentificationIdentificationArray(builder.ToImmutable());
        }
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ReleasePointIdentificationIdentificationArray FromRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// other overloads which avoid this serialization step.
        /// </remarks>
        public static ReleasePointIdentificationIdentificationArray FromRange<T>(IEnumerable<T> items)
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.Identification> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.Identification>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.Identification>(this.arrayBacking);
            }
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<ReleasePointIdentificationIdentificationArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<ReleasePointIdentificationIdentificationArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
