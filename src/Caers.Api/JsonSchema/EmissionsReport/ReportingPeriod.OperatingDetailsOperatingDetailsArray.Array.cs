...
public readonly partial struct ReportingPeriod
{
    ...
    public readonly partial struct OperatingDetailsOperatingDetailsArray : IJsonArray<OperatingDetailsOperatingDetailsArray>
    {
        ...
        public static OperatingDetailsOperatingDetailsArray FromItems(in Caers.Api.OperatingDetails value1)
        {
        ...
        /// <returns>A OperatingDetailsOperatingDetailsArray instantiated from the given items.</returns>
        public static OperatingDetailsOperatingDetailsArray FromItems(in Caers.Api.OperatingDetails value1, in Caers.Api.OperatingDetails value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A OperatingDetailsOperatingDetailsArray instantiated from the given items.</returns>
        public static OperatingDetailsOperatingDetailsArray FromItems(in Caers.Api.OperatingDetails value1, in Caers.Api.OperatingDetails value2, in Caers.Api.OperatingDetails value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static OperatingDetailsOperatingDetailsArray FromItems(params Caers.Api.OperatingDetails[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.OperatingDetails item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static OperatingDetailsOperatingDetailsArray FromRange(IEnumerable<Caers.Api.OperatingDetails> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.OperatingDetails item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.OperatingDetails> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.OperatingDetails>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.OperatingDetails>(this.arrayBacking);
            }
