...
public readonly partial struct ReportingPeriodDataType
{
    ...
    public readonly partial struct EmissionsDataTypeArray : IJsonArray<EmissionsDataTypeArray>
    {
        ...
        public static EmissionsDataTypeArray FromItems(in Caers.Api.EmissionsDataType value1)
        {
        ...
        /// <returns>A EmissionsDataTypeArray instantiated from the given items.</returns>
        public static EmissionsDataTypeArray FromItems(in Caers.Api.EmissionsDataType value1, in Caers.Api.EmissionsDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A EmissionsDataTypeArray instantiated from the given items.</returns>
        public static EmissionsDataTypeArray FromItems(in Caers.Api.EmissionsDataType value1, in Caers.Api.EmissionsDataType value2, in Caers.Api.EmissionsDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static EmissionsDataTypeArray FromItems(params Caers.Api.EmissionsDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.EmissionsDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static EmissionsDataTypeArray FromRange(IEnumerable<Caers.Api.EmissionsDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.EmissionsDataType item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.EmissionsDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.EmissionsDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.EmissionsDataType>(this.arrayBacking);
            }
