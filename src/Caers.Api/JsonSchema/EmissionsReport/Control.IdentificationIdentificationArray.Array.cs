...
public readonly partial struct Control
{
    ...
    public readonly partial struct IdentificationIdentificationArray : IJsonArray<IdentificationIdentificationArray>
    {
        ...
        public static IdentificationIdentificationArray FromItems(in Caers.Api.Identification value1)
        {
        ...
        /// <returns>A IdentificationIdentificationArray instantiated from the given items.</returns>
        public static IdentificationIdentificationArray FromItems(in Caers.Api.Identification value1, in Caers.Api.Identification value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A IdentificationIdentificationArray instantiated from the given items.</returns>
        public static IdentificationIdentificationArray FromItems(in Caers.Api.Identification value1, in Caers.Api.Identification value2, in Caers.Api.Identification value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static IdentificationIdentificationArray FromItems(params Caers.Api.Identification[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static IdentificationIdentificationArray FromRange(IEnumerable<Caers.Api.Identification> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.Identification item in value)
            {
