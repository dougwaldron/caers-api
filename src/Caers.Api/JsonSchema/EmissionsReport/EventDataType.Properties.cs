...
public readonly partial struct EventDataType
{
    ...
    /// </summary>
    public Caers.Api.EventDataType.EventReportingPeriodDataTypeArray EventReportingPeriod
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.EventDataType.EventReportingPeriodDataTypeArray(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.EventDataType.EventReportingPeriodDataTypeArray>();
                }
            }
    ...
    public static EventDataType Create(Corvus.Json.JsonString eventIdentifier, Corvus.Json.JsonString programSystemCode, Corvus.Json.JsonDateTime? containmentDate = null, Corvus.Json.JsonString? eventClassificationCode = null, Corvus.Json.JsonString? eventComment = null, Corvus.Json.JsonString? eventName = null, Caers.Api.EventDataType.EventReportingPeriodDataTypeArray? eventReportingPeriod = null, Corvus.Json.JsonString? eventSizeSourceCode = null, Corvus.Json.JsonString? fuelConsumptionAndEmissionsModelCode = null, Corvus.Json.JsonString? fuelSelectionCode = null, Corvus.Json.JsonString? fuelTypeModelCode = null, Corvus.Json.JsonString? groundBasedDataSourceCode = null, Corvus.Json.JsonString? ignitionLocationCode = null, Corvus.Json.JsonString? ignitionMethodCode = null, Corvus.Json.JsonString? ignitionOrientationCode = null, Corvus.Json.JsonString? landManager = null, Corvus.Json.JsonString? locationDescription = null, Corvus.Json.JsonString? recurrenceIndicatorCode = null, Corvus.Json.JsonDateTime? recurrenceYear = null, Corvus.Json.JsonString? remoteSensingDataSourceCode = null)
    {
        ...
        if (eventReportingPeriod is Caers.Api.EventDataType.EventReportingPeriodDataTypeArray eventReportingPeriod__)
        {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public EventDataType WithEventReportingPeriod(in Caers.Api.EventDataType.EventReportingPeriodDataTypeArray value)
    {
    ...
    {
        return property.ValueAs<Caers.Api.EventDataType.EventReportingPeriodDataTypeArray>().Validate(validationContext, level);
    }
