...
public readonly partial struct EmissionsReport
{
    ...
    public readonly partial struct EventDataTypeArray : IJsonArray<EventDataTypeArray>
    {
        ...
        public static EventDataTypeArray FromItems(in Caers.Api.EventDataType value1)
        {
        ...
        /// <returns>A EventDataTypeArray instantiated from the given items.</returns>
        public static EventDataTypeArray FromItems(in Caers.Api.EventDataType value1, in Caers.Api.EventDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A EventDataTypeArray instantiated from the given items.</returns>
        public static EventDataTypeArray FromItems(in Caers.Api.EventDataType value1, in Caers.Api.EventDataType value2, in Caers.Api.EventDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static EventDataTypeArray FromItems(params Caers.Api.EventDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.EventDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static EventDataTypeArray FromRange(IEnumerable<Caers.Api.EventDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.EventDataType item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.EventDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.EventDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.EventDataType>(this.arrayBacking);
            }
