...
public readonly partial struct EventLocationDataType
{
    ...
    /// </summary>
    public Caers.Api.EventLocationDataType.EventEmissionsProcessDataTypeArray EventEmissionsProcess
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.EventLocationDataType.EventEmissionsProcessDataTypeArray(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.EventLocationDataType.EventEmissionsProcessDataTypeArray>();
                }
            }
    ...
    /// </summary>
    public Caers.Api.GeographicCoordinatesDataType EventGeographicCoordinates
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.GeographicCoordinatesDataType(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.GeographicCoordinatesDataType>();
                }
            }
    ...
    /// </summary>
    public static EventLocationDataType Create(Caers.Api.EventLocationDataType.EventEmissionsProcessDataTypeArray eventEmissionsProcess, Caers.Api.GeographicCoordinatesDataType? eventGeographicCoordinates = null, Corvus.Json.JsonString? stateAndCountryFICode = null, Corvus.Json.JsonString? stateAndCountyFICode = null, Corvus.Json.JsonString? tribalCode = null)
    {
        var builder = ImmutableDictionary.CreateBuilder<JsonPropertyName, JsonAny>();
        builder.Add(EventEmissionsProcessJsonPropertyName, eventEmissionsProcess.AsAny);
        if (eventGeographicCoordinates is Caers.Api.GeographicCoordinatesDataType eventGeographicCoordinates__)
        {
    ...
    public EventLocationDataType WithEventEmissionsProcess(in Caers.Api.EventLocationDataType.EventEmissionsProcessDataTypeArray value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public EventLocationDataType WithEventGeographicCoordinates(in Caers.Api.GeographicCoordinatesDataType value)
    {
    ...
    {
        return property.ValueAs<Caers.Api.EventLocationDataType.EventEmissionsProcessDataTypeArray>().Validate(validationContext, level);
    }
    ...
    {
        return property.ValueAs<Caers.Api.GeographicCoordinatesDataType>().Validate(validationContext, level);
    }
