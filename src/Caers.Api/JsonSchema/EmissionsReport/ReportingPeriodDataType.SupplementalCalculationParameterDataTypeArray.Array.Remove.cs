...
public readonly partial struct ReportingPeriodDataType
{
    ...
    public readonly partial struct SupplementalCalculationParameterDataTypeArray
    {
        ...
        public SupplementalCalculationParameterDataTypeArray Remove(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SupplementalCalculationParameterDataTypeArray RemoveAt(int index)
        {
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SupplementalCalculationParameterDataTypeArray RemoveRange(int index, int count)
        {
