...
public readonly partial struct FacilitySite
{
    ...
    public readonly partial struct ControlPathArray : IJsonArray<ControlPathArray>
    {
        ...
        public static ControlPathArray FromItems(in Caers.Api.ControlPath value1)
        {
        ...
        /// <returns>A ControlPathArray instantiated from the given items.</returns>
        public static ControlPathArray FromItems(in Caers.Api.ControlPath value1, in Caers.Api.ControlPath value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A ControlPathArray instantiated from the given items.</returns>
        public static ControlPathArray FromItems(in Caers.Api.ControlPath value1, in Caers.Api.ControlPath value2, in Caers.Api.ControlPath value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static ControlPathArray FromItems(params Caers.Api.ControlPath[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ControlPath item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static ControlPathArray FromRange(IEnumerable<Caers.Api.ControlPath> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.ControlPath item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.ControlPath> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ControlPath>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.ControlPath>(this.arrayBacking);
            }
