...
public readonly partial struct ReleasePointAppt
{
    ...
    /// </summary>
    public readonly partial struct AveragePercentEmissionsEntity : IJsonNumber<AveragePercentEmissionsEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "AveragePercentEmissionsEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public AveragePercentEmissionsEntity(double value)
        {
        ...
        public static implicit operator JsonNumber(AveragePercentEmissionsEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator AveragePercentEmissionsEntity(JsonNumber value)
        {
        ...
        public static implicit operator AveragePercentEmissionsEntity(double value)
        {
            return new(value);
        }
        ...
        public static implicit operator double (AveragePercentEmissionsEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator AveragePercentEmissionsEntity(float value)
        {
            return new(value);
        }
        ...
        public static implicit operator float (AveragePercentEmissionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator AveragePercentEmissionsEntity(int value)
        {
            return new(value);
        }
        ...
        public static implicit operator int (AveragePercentEmissionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator AveragePercentEmissionsEntity(long value)
        {
            return new(value);
        }
        ...
        public static implicit operator long (AveragePercentEmissionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator AveragePercentEmissionsEntity(uint value)
        {
            return new(value);
        }
        ...
        public static implicit operator uint (AveragePercentEmissionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator AveragePercentEmissionsEntity(ushort value)
        {
            return new(value);
        }
        ...
        public static implicit operator ushort (AveragePercentEmissionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator AveragePercentEmissionsEntity(ulong value)
        {
            return new(value);
        }
        ...
        public static implicit operator ulong (AveragePercentEmissionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator AveragePercentEmissionsEntity(byte value)
        {
            return new(value);
        }
        ...
        public static implicit operator byte (AveragePercentEmissionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator AveragePercentEmissionsEntity(sbyte value)
        {
            return new(value);
        }
        ...
        public static implicit operator sbyte (AveragePercentEmissionsEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
