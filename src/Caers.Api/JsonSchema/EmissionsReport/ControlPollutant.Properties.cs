...
public readonly partial struct ControlPollutant
{
    ...
    /// </summary>
    public Caers.Api.ControlPollutant.PercentControlMeasuresReductionEfficiencyEntity PercentControlMeasuresReductionEfficiency
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.ControlPollutant.PercentControlMeasuresReductionEfficiencyEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.ControlPollutant.PercentControlMeasuresReductionEfficiencyEntity>();
                }
            }
    ...
    /// </summary>
    public static ControlPollutant Create(Caers.Api.ControlPollutant.PercentControlMeasuresReductionEfficiencyEntity percentControlMeasuresReductionEfficiency, Caers.Api.Pollutant pollutantCode)
    {
    ...
    public ControlPollutant WithPercentControlMeasuresReductionEfficiency(in Caers.Api.ControlPollutant.PercentControlMeasuresReductionEfficiencyEntity value)
    {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public ControlPollutant WithPollutantCode(in Caers.Api.Pollutant value)
    {
    ...
    {
        return property.ValueAs<Caers.Api.ControlPollutant.PercentControlMeasuresReductionEfficiencyEntity>().Validate(validationContext, level);
    }
