...
public readonly partial struct Emission
{
    ...
    /// </summary>
    public readonly partial struct OverallControlPercentEntity : IJsonNumber<OverallControlPercentEntity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref = "OverallControlPercentEntity"/> struct.
        /// </summary>
        /// <param name = "value">The value from which to construct the instance.</param>
        public OverallControlPercentEntity(double value)
        {
        ...
        public static implicit operator JsonNumber(OverallControlPercentEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value from which to convert.</param>
        public static implicit operator OverallControlPercentEntity(JsonNumber value)
        {
        ...
        public static implicit operator OverallControlPercentEntity(double value)
        {
            return new(value);
        }
        ...
        public static implicit operator double (OverallControlPercentEntity value)
        {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator OverallControlPercentEntity(float value)
        {
            return new(value);
        }
        ...
        public static implicit operator float (OverallControlPercentEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator OverallControlPercentEntity(int value)
        {
            return new(value);
        }
        ...
        public static implicit operator int (OverallControlPercentEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator OverallControlPercentEntity(long value)
        {
            return new(value);
        }
        ...
        public static implicit operator long (OverallControlPercentEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static explicit operator OverallControlPercentEntity(uint value)
        {
            return new(value);
        }
        ...
        public static implicit operator uint (OverallControlPercentEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator OverallControlPercentEntity(ushort value)
        {
            return new(value);
        }
        ...
        public static implicit operator ushort (OverallControlPercentEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator OverallControlPercentEntity(ulong value)
        {
            return new(value);
        }
        ...
        public static implicit operator ulong (OverallControlPercentEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator OverallControlPercentEntity(byte value)
        {
            return new(value);
        }
        ...
        public static implicit operator byte (OverallControlPercentEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// </summary>
        /// <param name = "value">The value to convert.</param>
        public static implicit operator OverallControlPercentEntity(sbyte value)
        {
            return new(value);
        }
        ...
        public static implicit operator sbyte (OverallControlPercentEntity value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
