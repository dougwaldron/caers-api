...
public readonly partial struct EventReportingPeriodDataType
{
    ...
    public readonly partial struct EventLocationDataTypeArray : IJsonArray<EventLocationDataTypeArray>
    {
        ...
        public static EventLocationDataTypeArray FromItems(in Caers.Api.EventLocationDataType value1)
        {
        ...
        /// <returns>A EventLocationDataTypeArray instantiated from the given items.</returns>
        public static EventLocationDataTypeArray FromItems(in Caers.Api.EventLocationDataType value1, in Caers.Api.EventLocationDataType value2)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
        ...
        /// <returns>A EventLocationDataTypeArray instantiated from the given items.</returns>
        public static EventLocationDataTypeArray FromItems(in Caers.Api.EventLocationDataType value1, in Caers.Api.EventLocationDataType value2, in Caers.Api.EventLocationDataType value3)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            builder.Add(value1.AsAny);
            builder.Add(value2.AsAny);
        ...
        public static EventLocationDataTypeArray FromItems(params Caers.Api.EventLocationDataType[] value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.EventLocationDataType item in value)
            {
        ...
        /// <param name = "value">The value from which to construct the instance.</param>
        /// <returns>A JsonAny instantiated from the given items.</returns>
        public static EventLocationDataTypeArray FromRange(IEnumerable<Caers.Api.EventLocationDataType> value)
        {
            ImmutableList<JsonAny>.Builder builder = ImmutableList.CreateBuilder<JsonAny>();
            foreach (Caers.Api.EventLocationDataType item in value)
            {
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<Caers.Api.EventLocationDataType> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.EventLocationDataType>(this.jsonElementBacking);
            }

            if ((this.backing & Backing.Array) != 0)
            {
                return new JsonArrayEnumerator<Caers.Api.EventLocationDataType>(this.arrayBacking);
            }
