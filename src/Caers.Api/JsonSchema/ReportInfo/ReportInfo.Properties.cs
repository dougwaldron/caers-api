...
public readonly partial struct ReportInfo
{
    ...
    /// Gets Status.
    /// </summary>
    public Caers.Api.ReportInfo.StatusEntity Status
    {
        get
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                ...
                {
                    return new Caers.Api.ReportInfo.StatusEntity(result);
                }
            }
            ...
            if ((this.backing & Backing.Object) != 0)
            {
                ...
                {
                    return result.As<Caers.Api.ReportInfo.StatusEntity>();
                }
            }
    ...
    /// </summary>
    public static ReportInfo Create(Corvus.Json.JsonString? agencyFacilityIdentifier = null, Corvus.Json.JsonDateTime? certifiedDate = null, Corvus.Json.JsonDateTime? modifiedDate = null, Corvus.Json.JsonInteger? reportId = null, Caers.Api.ReportInfo.StatusEntity? status = null)
    {
        ...
        if (status is Caers.Api.ReportInfo.StatusEntity status__)
        {
    ...
    /// <param name = "value">The value to set.</param>
    /// <returns>The entity with the updated property.</returns>
    public ReportInfo WithStatus(in Caers.Api.ReportInfo.StatusEntity value)
    {
    ...
    {
        return property.ValueAs<Caers.Api.ReportInfo.StatusEntity>().Validate(validationContext, level);
    }
